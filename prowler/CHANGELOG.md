...
- Azure `postgresql_flexible_server_log_retention_days_greater_3` no longer always fails by querying the retired Single Server `log_retention_days` parameter; it now reads the Flexible Server `logfiles.retention_days` parameter [(#11766)](https://github.com/prowler-cloud/prowler/pull/11766)
