...
- `entra_conditional_access_policy_compliant_device_or_hybrid_joined_device_or_mfa_required` check for m365 provider [(#10197)](https://github.com/prowler-cloud/prowler/pull/10197)
