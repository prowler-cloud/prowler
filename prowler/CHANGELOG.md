...
- Azure `CosmosDB._get_accounts` raising `TypeError: 'NoneType' object is not iterable` when an account returns `private_endpoint_connections: None` instead of an empty list [(#11031)](https://github.com/prowler-cloud/prowler/pull/11031)
