...
- Official Prowler GitHub Action (`prowler-cloud/prowler@v1`) for running scans in GitHub workflows with optional `--push-to-cloud` and SARIF upload to GitHub Code Scanning [(#PR_NUMBER)](https://github.com/prowler-cloud/prowler/pull/PR_NUMBER)
