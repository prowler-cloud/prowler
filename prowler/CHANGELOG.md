...
- Official Prowler GitHub Action (`prowler-cloud/prowler@5.24.3`) for running scans in GitHub workflows with optional `--push-to-cloud` and SARIF upload to GitHub Code Scanning [(#10872)](https://github.com/prowler-cloud/prowler/pull/10872)
