...
- `entra_users_mfa_capable` evaluating disabled guest accounts; CIS 5.2.3.4 only targets enabled member users [(#PR_NUMBER)](https://github.com/prowler-cloud/prowler/pull/PR_NUMBER)
