...
- Initial Okta provider with OAuth 2.0 (private-key JWT) authentication and the `signon_global_session_idle_timeout_15min` check (DISA STIG V-273186) [(#11079)](https://github.com/prowler-cloud/prowler/pull/11079)
