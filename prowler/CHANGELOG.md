...
- Azure CIS compliance entries for legacy Network Watcher flow log controls now use retirement-aware remediation and audit guidance that points new deployments to VNet flow logs
