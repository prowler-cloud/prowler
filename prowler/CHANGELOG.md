...
- `entra_service_principal_privileged_role_no_owners` - Added new M365 check to detect service principals with privileged Entra directory roles that have owners, closing a known privilege escalation path [#11070](https://github.com/prowler-cloud/prowler/pull/11093)
