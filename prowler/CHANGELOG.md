...
## [UNRELEASED] (Prowler vX.X.X)

### 🚀 Added

- `entra_conditional_access_policy_device_registration_mfa_required` and `entra_conditional_access_policy_intune_enrollment_mfa` checks for M365 provider [(#10222)](https://github.com/prowler-cloud/prowler/pull/10222)
