...
- Remove deprecated docs.prowler.com URLs from all providers metadata (AWS, Azure, Kubernetes, OracleCloud - canonical source is now hub.prowler.com) [(#10068)](https://github.com/prowler-cloud/prowler/pull/10068)
