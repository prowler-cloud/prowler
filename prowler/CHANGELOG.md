...
- Jira timeout preventing the calls from hanging indefinitely when the Jira endpoint is unreachable or slow [(#XXXXX)](https://github.com/prowler-cloud/prowler/pull/XXXXX)
