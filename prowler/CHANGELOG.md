...
- Okta, Alibaba Cloud and OpenStack scan-config sections are now validated against a registered schema instead of being silently accepted and ignored, so their configurable thresholds (session/idle timeouts, retention days, image-sharing and secret-scanning settings) surface out-of-range values as errors [(#11725)](https://github.com/prowler-cloud/prowler/pull/11725)
