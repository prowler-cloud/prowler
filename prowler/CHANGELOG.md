...
- Oracle Cloud `kms_key_rotation_enabled` now checks current key version age to avoid false positives on vaults without auto-rotation support [(#10434)](https://github.com/prowler-cloud/prowler/issues/10434)
