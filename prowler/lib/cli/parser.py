...
class ProwlerArgumentParser:
    ...
    def __init__(self):
        ...
        self.parser = argparse.ArgumentParser(
            ...
            usage="prowler [-h] [--version] {aws,azure,gcp,kubernetes,m365,github,cloudflare,nhn,mongodbatlas,oraclecloud,dashboard,iac} ...",
            epilog="""
Available Cloud Providers:
  {aws,azure,gcp,kubernetes,m365,github,cloudflare,iac,llm,nhn,mongodbatlas,oraclecloud}
    aws                 AWS Provider
