...
class AzureKISAISMSP(ComplianceOutput):
    """
    This class represents the Azure KISA-ISMS-P compliance output.
    ...
    Methods:
        - transform: Transforms findings into Azure KISA-ISMS-P compliance format.
    """
    ...
    def transform(
        ...
        """
        Transforms a list of findings into Azure KISA-ISMS-P compliance format.
            ...
            for requirement in compliance.Requirements:
                if requirement.Id in finding_requirements:
                    for attribute in requirement.Attributes:
                        compliance_row = AzureKISAISMSPModel(
