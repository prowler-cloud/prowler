...
from prowler.lib.outputs.compliance.iso27001.models import GithubISO27001Model
from prowler.lib.outputs.finding import Finding


class GithubISO27001(ComplianceOutput):
    """
    This class represents the GitHub ISO 27001 compliance output.
    ...
    Methods:
        - transform: Transforms findings into GitHub ISO 27001 compliance format.
    """
    ...
    def transform(
        ...
        """
        Transforms a list of findings into GitHub ISO 27001 compliance format.
            ...
            for requirement in compliance.Requirements:
                ...
                if finding.check_id in requirement.Checks:
                    ...
                    for attribute in requirement.Attributes:
                        compliance_row = GithubISO27001Model(
