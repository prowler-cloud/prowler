...
Ensures that the RAM password policy requires at least one uppercase letter.
...
class ram_password_require_uppercase(Check):
    """Check if the RAM password policy requires at least one uppercase letter"""

    def execute(self):
        """Execute the ram_password_require_uppercase check"""
        findings = []
        ...
        if ram_client.password_policy and ram_client.password_policy.require_uppercase:
            report.status = "PASS"
            report.status_extended = "RAM password policy requires at least one uppercase letter."
        else:
            report.status = "FAIL"
            report.status_extended = "RAM password policy does not require uppercase letters. Enable the uppercase letter requirement to increase password complexity."
