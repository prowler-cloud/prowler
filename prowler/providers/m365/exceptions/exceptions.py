...
# Exceptions codes from 5000 to 5999 are reserved for Microsoft 365 exceptions
class M365BaseException(ProwlerException):
    """Base class for Microsoft 365 Errors."""
    ...
    def __init__(self, code, file=None, original_exception=None, message=None):
        provider = "M365"
        error_info = self.M365_ERROR_CODES.get((code, self.__class__.__name__))
        if message:
...
class M365CredentialsError(M365BaseException):
    """Base class for Microsoft 365 credentials errors."""
