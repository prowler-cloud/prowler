    ...
    def execute(self):
        ...
        for function in awslambda_client.functions.values():
            ...
            if function.arn in public_lambda_functions:
                report.status = "FAIL"
                report.status_extended = f"Lambda function {function.name} is publicly accesible through an Internet facing Load Balancer through target group {public_lambda_functions[function.arn]}."
