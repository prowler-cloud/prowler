...
class resourceexplorer2_indexes_found(Check):
    def execute(self):
        ...
        report.resource_arn = f"arn:{resource_explorer_2_client.audited_partition}:resource-explorer:{resource_explorer_2_client.region}:{resource_explorer_2_client.audited_account}:index"
