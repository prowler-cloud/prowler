...
from prowler.providers.aws.services.resourceexplorer2.resourceexplorer2_client import resource_explorer_2_client
    ...
    def execute(self):
        ...
        if resource_explorer_2_client.indexes:
            ...
            report.status_extended = (
                f"Resource Explorer Indexes found: {len(resource_explorer_2_client.indexes)}"
            )
