...
class SageMaker(AWSService):
    def __init__(self, provider):
        ...
        self.__threading_call__(self._describe_model)
        self.__threading_call__(self._describe_notebook_instance)
        self.__threading_call__(self._describe_training_job)
        self.__threading_call__(self._describe_endpoint_config)
    ...
    def _describe_endpoint_config(self, regional_clients):
        ...
        try:
            for endpoint_config in self.endpoint_configs.values():
                ...
                production_variants = []
                for production_variant in describe_endpoint_config[
                    "ProductionVariants"
                ]:
