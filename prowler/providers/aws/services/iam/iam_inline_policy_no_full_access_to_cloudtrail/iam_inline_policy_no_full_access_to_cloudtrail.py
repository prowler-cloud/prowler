        ...
        for policy in iam_client.policies:
            ...
            if policy.type == "Inline":
                ...
                if policy.document and check_full_service_access(
                    ...
                    report.status = "FAIL"
                    report.status_extended = f"{policy.type} policy {policy.name}{' attached to ' + resource_type_str + ' ' + report.resource_arn if policy.attached else ''} allows '{critical_service}:*' privileges to all resources."
