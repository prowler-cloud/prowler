...
class DNS(GCPService):
    def __init__(self, audit_info):
        ...
        self.managed_zones = []
        self.policies = []
        self.__threading_call__(self.__get_managed_zones__, self.project_ids)
        self.__threading_call__(self.__get_policies__, self.project_ids)

    def __get_managed_zones__(self, project_id):
        try:
    ...
    def __get_policies__(self, project_id):
        try:
