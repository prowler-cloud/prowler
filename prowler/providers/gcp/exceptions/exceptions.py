...
class GCPCloudResourceManagerAPINotUsedError(GCPBaseException):
    def __init__(self, file=None, original_exception=None):
        super().__init__(
            1925, provider="GCP", file=file, original_exception=original_exception
        )
...
class GCPHTTPError(GCPBaseException):
    def __init__(self, file=None, original_exception=None):
        super().__init__(
            1926, provider="GCP", file=file, original_exception=original_exception
        )
...
class GCPNoAccesibleProjectsError(GCPBaseException):
    def __init__(self, file=None, original_exception=None):
        super().__init__(
            1927, provider="GCP", file=file, original_exception=original_exception
        )
...
class GCPSetUpSessionError(GCPBaseException):
    def __init__(self, file=None, original_exception=None):
        super().__init__(
            1928, provider="GCP", file=file, original_exception=original_exception
        )
...
class GCPGetProjectError(GCPBaseException):
    def __init__(self, file=None, original_exception=None):
        super().__init__(
            1929, provider="GCP", file=file, original_exception=original_exception
        )
...
class GCPTestConnectionError(GCPBaseException):
    def __init__(self, file=None, original_exception=None):
        super().__init__(
            1930, provider="GCP", file=file, original_exception=original_exception
        )
