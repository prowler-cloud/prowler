...
class Test_ec2_instance_port_mysql_exposed_to_internet:
    ...
    def test_ec2_instance_no_port_exposed(self):
        ...
        with mock.patch(
            ...
            assert (
                ...
                == f"Instance {instance_id} does not have Memcached port 3306 open to the Internet."
            )
    ...
    def test_ec2_instance_exposed_port_in_public_subnet(self):
        ...
        with mock.patch(
            ...
            assert (
                result[0].status_extended
                == f"Instance {instance.id} has Memcached exposed to 0.0.0.0/0 on public ip address {instance.public_ip_address} but in private subnet {subnet_id}."
            )
