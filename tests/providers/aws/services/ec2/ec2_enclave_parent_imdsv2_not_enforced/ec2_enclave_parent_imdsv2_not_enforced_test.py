...
CHECK_MODULE = (
    "prowler.providers.aws.services.ec2.ec2_enclave_parent_imdsv2_not_enforced"
    ".ec2_enclave_parent_imdsv2_not_enforced"
)


class Test_ec2_enclave_parent_imdsv2_not_enforced:
    @mock_aws
    def test_no_instances(self):
        ...
        with (
            ...
            from prowler.providers.aws.services.ec2.ec2_enclave_parent_imdsv2_not_enforced.ec2_enclave_parent_imdsv2_not_enforced import (
                ec2_enclave_parent_imdsv2_not_enforced,
            )

            assert ec2_enclave_parent_imdsv2_not_enforced().execute() == []
    ...
    def test_enclave_parent_imdsv2_enforced_pass(self):
        ...
        with (
            ...
            result = ec2_enclave_parent_imdsv2_not_enforced().execute()
            assert len(result) == 1
