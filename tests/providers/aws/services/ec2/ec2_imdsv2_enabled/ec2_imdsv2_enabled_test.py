...
class Test_ec2_imdsv2_enabled:
    ...
    def test_ec2_imdsv2_required(self):
        ...
        with mock.patch(
            ...
            "prowler.providers.aws.services.ec2.ec2_imdsv2_enabled.ec2_imdsv2_enabled.ec2_client",
            new=ec2_client,
        ):
            # Test Check
            from prowler.providers.aws.services.ec2.ec2_imdsv2_enabled.ec2_imdsv2_enabled import (
                ec2_imdsv2_enabled,
            )
            ...
            assert (
                ...
                == f"IMDSv2 is enabled for region {AWS_REGION_US_EAST_1}."
            )
            assert (
    ...
    def test_ec2_imdsv2_none(self):
        ...
        with mock.patch(
            ...
            assert (
                result[0].status_extended
                == f"IMDSv2 is not enabled for region {AWS_REGION_US_EAST_1}."
            )
            assert (
                result[0].resource_arn
                == f"arn:aws:ec2:{AWS_REGION_US_EAST_1}:{AWS_ACCOUNT_NUMBER}"
