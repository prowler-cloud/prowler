...
CHECK_MODULE = (
    "prowler.providers.aws.services.ec2.ec2_enclave_parent_public_ip_exposed"
    ".ec2_enclave_parent_public_ip_exposed"
)
...
class Test_ec2_enclave_parent_public_ip_exposed:
    @mock_aws
    def test_no_instances(self):
        ...
        with (
            ...
            from prowler.providers.aws.services.ec2.ec2_enclave_parent_public_ip_exposed.ec2_enclave_parent_public_ip_exposed import (
                ec2_enclave_parent_public_ip_exposed,
            )

            assert ec2_enclave_parent_public_ip_exposed().execute() == []
    ...
    def test_enclave_in_private_subnet_no_public_ip_pass(self):
        ...
        with (
            ...
            result = ec2_enclave_parent_public_ip_exposed().execute()
            assert len(result) == 1
