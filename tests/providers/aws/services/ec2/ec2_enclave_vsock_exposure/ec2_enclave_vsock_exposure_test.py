...
CHECK_MODULE = (
    "prowler.providers.aws.services.ec2.ec2_enclave_vsock_exposure"
    ".ec2_enclave_vsock_exposure"
)
...
class Test_ec2_enclave_vsock_exposure:
    @mock_aws
    def test_no_instances(self):
        ...
        with (
            ...
            from prowler.providers.aws.services.ec2.ec2_enclave_vsock_exposure.ec2_enclave_vsock_exposure import (
                ec2_enclave_vsock_exposure,
            )

            assert ec2_enclave_vsock_exposure().execute() == []
    ...
    def test_no_vsock_ports_exposed_pass(self):
        ...
        with (
            ...
            result = ec2_enclave_vsock_exposure().execute()
            assert len(result) == 1
