...
CHECK_MODULE = (
    "prowler.providers.aws.services.ec2.ec2_enclave_parent_security_group_exposed"
    ".ec2_enclave_parent_security_group_exposed"
)
...
class Test_ec2_enclave_parent_security_group_exposed:
    @mock_aws
    def test_no_instances(self):
        ...
        with (
            ...
            from prowler.providers.aws.services.ec2.ec2_enclave_parent_security_group_exposed.ec2_enclave_parent_security_group_exposed import (
                ec2_enclave_parent_security_group_exposed,
            )

            assert ec2_enclave_parent_security_group_exposed().execute() == []
    ...
    def test_only_allow_listed_ports_pass(self):
        ...
        with (
            ...
            result = ec2_enclave_parent_security_group_exposed().execute()
            assert len(result) == 1
