...
class Test_dms_endpoint_ssl_enabled:
    ...
    def test_dms_endpoint_ssl_none(self):
        dms_client = mock.MagicMock
        dms_client.endpoints = {
            "test-endpoint-no-ssl": Endpoint(ssl_mode="none")
        }
        ...
        with mock.patch(
            ...
            assert result[0].resource_arn == f"arn:aws:dms:{AWS_REGION_US_EAST_1}:{AWS_ACCOUNT_NUMBER}:endpoint:test-endpoint-no-ssl"
    ...
    def test_dms_endpoint_ssl_require(self):
        dms_client = mock.MagicMock
        dms_client.endpoints = {
            "test-endpoint-ssl-require": Endpoint(ssl_mode="require")
        }
        dms_client.audited_account = AWS_ACCOUNT_NUMBER
        dms_client.audited_partition = "aws"
        dms_client.audited_region = AWS_REGION_US_EAST_1
        ...
        with mock.patch(
            ...
            assert result[0].resource_arn == f"arn:aws:dms:{AWS_REGION_US_EAST_1}:{AWS_ACCOUNT_NUMBER}:endpoint:test-endpoint-ssl-require"
            assert result[0].region == AWS_REGION_US_EAST_1
    ...
    def test_dms_endpoint_ssl_verify_ca(self):
        dms_client = mock.MagicMock
        dms_client.endpoints = {
            "test-endpoint-ssl-verify-ca": Endpoint(ssl_mode="verify-ca")
        }
        dms_client.audited_account = AWS_ACCOUNT_NUMBER
        dms_client.audited_partition = "aws"
        dms_client.audited_region = AWS_REGION_US_EAST_1
        ...
        with mock.patch(
            ...
            assert result[0].resource_arn == f"arn:aws:dms:{AWS_REGION_US_EAST_1}:{AWS_ACCOUNT_NUMBER}:endpoint:test-endpoint-ssl-verify-ca"
            assert result[0].region == AWS_REGION_US_EAST_1
    ...
    def test_dms_endpoint_ssl_verify_full(self):
        dms_client = mock.MagicMock
        dms_client.endpoints = {
            "test-endpoint-ssl-verify-full": Endpoint(ssl_mode="verify-full")
        }
        dms_client.audited_account = AWS_ACCOUNT_NUMBER
        dms_client.audited_partition = "aws"
        dms_client.audited_region = AWS_REGION_US_EAST_1
        ...
        with mock.patch(
            ...
            assert result[0].resource_arn == f"arn:aws:dms:{AWS_REGION_US_EAST_1}:{AWS_ACCOUNT_NUMBER}:endpoint:test-endpoint-ssl-verify-full"
            assert result[0].region == AWS_REGION_US_EAST_1
