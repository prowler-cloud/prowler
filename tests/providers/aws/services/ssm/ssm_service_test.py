...
class Test_SSM_Service:
    ...
    def test__get_client__(self):
        ...
        assert ssm.regional_clients[AWS_REGION_EU_WEST_1].__class__.__name__ == "SSM"
    ...
    def test__list_documents__(self):
        # Create SSM Document
        ssm_client = client("ssm", region_name=AWS_REGION_EU_WEST_1)
        ...
        document_arn = f"arn:aws:ssm:{AWS_REGION_EU_WEST_1}:{DEFAULT_ACCOUNT_ID}:document/{ssm_document_name}"
        ...
        assert ssm.documents[document_arn].region == AWS_REGION_EU_WEST_1
    ...
    def test__list_resource_compliance_summaries__(self):
        ...
        assert ssm.compliance_resources[instance_id].region == AWS_REGION_EU_WEST_1
