...
CHECK_MODULE = (
    "prowler.providers.aws.services.kms.kms_key_missing_enclave_attestation_condition"
    ".kms_key_missing_enclave_attestation_condition"
)
...
class Test_kms_key_missing_enclave_attestation_condition:
    @mock_aws
    def test_no_keys(self):
        ...
        with (
            ...
            from prowler.providers.aws.services.kms.kms_key_missing_enclave_attestation_condition.kms_key_missing_enclave_attestation_condition import (
                kms_key_missing_enclave_attestation_condition,
            )

            assert kms_key_missing_enclave_attestation_condition().execute() == []
    ...
    def test_enclave_key_with_attestation_pass(self):
        ...
        with (
            ...
            result = kms_key_missing_enclave_attestation_condition().execute()
            assert len(result) == 1
    ...
    def test_action_case_insensitive_without_attestation_fail(self):
        ...
        kms = client("kms", region_name=AWS_REGION_US_EAST_1)
        key = _create_enclave_tagged_key(
            kms, _policy_with_action("KMS:decrypt")
        )
    ...
    def test_stringlike_wildcard_value_treated_as_no_attestation_fail(self):
        ...
        key = _create_enclave_tagged_key(
            ...
            _policy_with_action(
                "kms:Decrypt",
                condition={
                    "StringLike": {"kms:RecipientAttestation:PCR0": "*"}
                },
            ),
        )
    ...
    def test_null_operator_treated_as_no_attestation_fail(self):
        ...
        key = _create_enclave_tagged_key(
            ...
            _policy_with_action(
                "kms:Decrypt",
                condition={
                    "Null": {"kms:RecipientAttestation:PCR0": "true"}
                },
            ),
        )
    ...
    def test_stringnotequals_treated_as_no_attestation_fail(self):
        ...
        key = _create_enclave_tagged_key(
            ...
            _policy_with_action(
                ...
                condition={
                    "StringNotEquals": {
                        "kms:RecipientAttestation:PCR0": "some-value"
                    }
                },
            ),
        )
