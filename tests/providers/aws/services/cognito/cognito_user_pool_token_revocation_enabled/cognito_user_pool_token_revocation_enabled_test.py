...
class Test_cognito_user_pool_token_revocation_enabled:
    def test_cognito_no_user_pools(self):
        ...
        with mock.patch(
            ...
            check = cognito_user_pool_token_revocation_enabled()
    ...
    def test_cognito_user_pools_token_revocation_disabled(self):
        ...
        cognito_client.user_pools = {
            user_pool_arn: UserPool(
                user_pool_client=UserPoolClient(enable_token_revocation=False),
    ...
    def test_project_user_pools_token_revocation_enabled(self):
        ...
        cognito_client.user_pools = {
            user_pool_arn: UserPool(
                user_pool_client=UserPoolClient(enable_token_revocation=True),
                region=AWS_REGION_US_EAST_1,
                id=user_pool_id,
                arn=user_pool_arn,
                name=user_pool_name,
