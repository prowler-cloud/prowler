...
class Test_cognito_identity_pool_guest_access_enabled:
    def test_cognito_no_identity_pools(self):
        ...
        with mock.patch(
            ...
            check = cognito_identity_pool_guest_access_enabled()
    ...
    def test_cognito_identity_pools_guest_access_disabled(self):
        ...
        with mock.patch(
            ...
            assert result[0].resource_name == identity_pool_name
    ...
    def test_cognito_identity_pools_guest_access_enabled(self):
        ...
        with mock.patch(
            ...
            assert (
                result[0].status_extended
                == f"Identity pool {identity_pool_id} has guest access enabled and unauthenticated role {unauthenticated_role} defined."
            )
            assert result[0].resource_name == identity_pool_name
            assert result[0].resource_id == identity_pool_id
            assert result[0].resource_arn == identity_pool_arn
