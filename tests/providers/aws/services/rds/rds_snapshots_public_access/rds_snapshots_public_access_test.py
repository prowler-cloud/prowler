        ...
        with mock.patch(
            ...
            with mock.patch(
                ...
                assert (
                    ...
                    == f"arn:aws:rds:{AWS_REGION_EU_WEST_1}:{AWS_ACCOUNT_NUMBER}:snapshot:snapshot-1"
                )
    ...
    def test_rds_cluster_private_snapshot(self):
        ...
        with mock.patch(
            ...
            with mock.patch(
                ...
                assert (
                    result[0].resource_arn
                    == f"arn:aws:rds:{AWS_REGION_EU_WEST_1}:{AWS_ACCOUNT_NUMBER}:cluster-snapshot:snapshot-1"
                )
                assert result[0].resource_tags == []
