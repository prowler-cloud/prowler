...
class Test_identity_storage_service_level_admins_scoped:
    def test_no_resources(self):
        """identity_storage_service_level_admins_scoped: No resources to check"""
        ...
        with (
            ...
            mock.patch(
                "prowler.providers.oraclecloud.services.identity.identity_storage_service_level_admins_scoped.identity_storage_service_level_admins_scoped.identity_client",
                new=identity_client,
            ),
        ):
            ...
            check = identity_storage_service_level_admins_scoped()
    ...
    def test_resource_compliant(self):
        """identity_storage_service_level_admins_scoped: Resource passes the check (PASS)"""
        identity_client = mock.MagicMock()
        identity_client.audited_compartments = {OCI_COMPARTMENT_ID: mock.MagicMock()}
        identity_client.audited_tenancy = OCI_TENANCY_ID
    ...
    def test_resource_non_compliant(self):
        """identity_storage_service_level_admins_scoped: Resource fails the check (FAIL)"""
        identity_client = mock.MagicMock()
        identity_client.audited_compartments = {OCI_COMPARTMENT_ID: mock.MagicMock()}
        identity_client.audited_tenancy = OCI_TENANCY_ID
