...
class Test_rds_instance_multi_az:
    def test_no_db_instances(self):
        ...
        with mock.patch(
            ...
            "prowler.providers.alibabacloud.services.rds.rds_instance_multi_az.rds_instance_multi_az.rds_client",
            new=rds_client,
        ):
            from prowler.providers.alibabacloud.services.rds.rds_instance_multi_az.rds_instance_multi_az import (
    ...
    def test_db_instance_multi_az_pass(self):
        rds_client = mock.MagicMock
        ...
        with mock.patch(
            ...
            assert "is deployed across multiple availability zones" in result[0].status_extended

    def test_db_instance_multi_az_fail(self):
        rds_client = mock.MagicMock
        ...
        with mock.patch(
            ...
            assert result[0].resource_id == db_instance_id
            assert "is not deployed across multiple availability zones" in result[0].status_extended
