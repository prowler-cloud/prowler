...
class Test_rds_instance_backup_enabled:
    def test_no_db_instances(self):
        ...
        with mock.patch(
            ...
            "prowler.providers.alibabacloud.services.rds.rds_instance_backup_enabled.rds_instance_backup_enabled.rds_client",
            new=rds_client,
        ):
            from prowler.providers.alibabacloud.services.rds.rds_instance_backup_enabled.rds_instance_backup_enabled import (
    ...
    def test_db_instance_backup_enabled_pass(self):
        rds_client = mock.MagicMock
        ...
        with mock.patch(
            ...
            assert "has automated backups enabled" in result[0].status_extended

    def test_db_instance_backup_enabled_fail(self):
        rds_client = mock.MagicMock
        ...
        with mock.patch(
            ...
            assert result[0].resource_id == db_instance_id
            assert "does not have automated backups enabled" in result[0].status_extended
