...
class Test_rds_instance_in_vpc:
    def test_no_db_instances(self):
        ...
        with mock.patch(
            ...
            "prowler.providers.alibabacloud.services.rds.rds_instance_in_vpc.rds_instance_in_vpc.rds_client",
            new=rds_client,
        ):
            from prowler.providers.alibabacloud.services.rds.rds_instance_in_vpc.rds_instance_in_vpc import (
                rds_instance_in_vpc,
            )
    ...
    def test_db_instance_vpc_id_pass(self):
        rds_client = mock.MagicMock
    ...
    def test_db_instance_vpc_id_fail(self):
        rds_client = mock.MagicMock
