...
class Test_rds_instance_deletion_protection:
    def test_no_db_instances(self):
        ...
        with mock.patch(
            ...
            "prowler.providers.alibabacloud.services.rds.rds_instance_deletion_protection.rds_instance_deletion_protection.rds_client",
            new=rds_client,
        ):
            from prowler.providers.alibabacloud.services.rds.rds_instance_deletion_protection.rds_instance_deletion_protection import (
    ...
    def test_db_instance_deletion_protection_pass(self):
        rds_client = mock.MagicMock
        ...
        with mock.patch(
            ...
            assert "has deletion protection enabled" in result[0].status_extended

    def test_db_instance_deletion_protection_fail(self):
        rds_client = mock.MagicMock
        ...
        with mock.patch(
            ...
            assert result[0].resource_id == db_instance_id
            assert "does not have deletion protection enabled" in result[0].status_extended
