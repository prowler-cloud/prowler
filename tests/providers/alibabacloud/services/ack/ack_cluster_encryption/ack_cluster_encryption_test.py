...
class Test_ack_cluster_encryption:
    def test_no_clusters(self):
        ...
        with mock.patch(
            ...
            "prowler.providers.alibabacloud.services.ack.ack_cluster_encryption.ack_cluster_encryption.ack_client",
            new=ack_client,
        ):
            from prowler.providers.alibabacloud.services.ack.ack_cluster_encryption.ack_cluster_encryption import (
                ack_cluster_encryption,
            )
    ...
    def test_cluster_encryption_enabled_pass(self):
        ack_client = mock.MagicMock
    ...
    def test_cluster_encryption_enabled_fail(self):
        ack_client = mock.MagicMock
