...
class Test_sls_alert_kms_key_changes:
    def test_no_alerts(self):
        ...
        with mock.patch(
            ...
            "prowler.providers.alibabacloud.services.sls.sls_alert_kms_key_changes.sls_alert_kms_key_changes.sls_client",
            new=sls_client,
        ):
            from prowler.providers.alibabacloud.services.sls.sls_alert_kms_key_changes.sls_alert_kms_key_changes import (
                sls_alert_kms_key_changes,
            )
    ...
    def test_alert_enabled_pass(self):
        ...
        with mock.patch(
            ...
            sls_client.alerts = {
                alert_arn: Alert(
                    name=alert_name,
                    display_name="Alert for KMS Key Changes",
            ...
            assert "KMS Key Changes" in result[0].status_extended
