...
class Test_sls_unauthorized_api_calls_alert:
    def test_no_alerts(self):
        ...
        with mock.patch(
            ...
            "prowler.providers.alibabacloud.services.sls.sls_alert_unauthorized_api_calls.sls_alert_unauthorized_api_calls.sls_client",
            new=sls_client,
        ):
            from prowler.providers.alibabacloud.services.sls.sls_alert_unauthorized_api_calls.sls_alert_unauthorized_api_calls import (
                sls_alert_unauthorized_api_calls,
            )
    ...
    def test_alert_enabled_pass(self):
        ...
        alert_name = "test-unauthorized-alert"
        ...
        with mock.patch(
            ...
            sls_client.alerts = {
                alert_arn: Alert(
                    name=alert_name,
                    display_name="Alert for Unauthorized API Calls",
            ...
            assert "Unauthorized API Calls" in result[0].status_extended
