...
class Test_sls_vpc_config_changes_alert:
    def test_no_alerts(self):
        ...
        with mock.patch(
            ...
            "prowler.providers.alibabacloud.services.sls.sls_alert_vpc_config_changes.sls_alert_vpc_config_changes.sls_client",
            new=sls_client,
        ):
            from prowler.providers.alibabacloud.services.sls.sls_alert_vpc_config_changes.sls_alert_vpc_config_changes import (
                sls_alert_vpc_config_changes,
            )
    ...
    def test_alert_enabled_pass(self):
        ...
        alert_name = "test-vpc-config-alert"
        ...
        with mock.patch(
            ...
            sls_client.alerts = {
                alert_arn: Alert(
                    name=alert_name,
                    display_name="Alert for VPC Configuration Changes",
            ...
            assert "VPC Configuration Changes" in result[0].status_extended
