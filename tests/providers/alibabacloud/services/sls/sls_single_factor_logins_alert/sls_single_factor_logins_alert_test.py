...
class Test_sls_alert_single_factor_logins:
    def test_no_alerts(self):
        ...
        with mock.patch(
            ...
            "prowler.providers.alibabacloud.services.sls.sls_alert_single_factor_logins.sls_alert_single_factor_logins.sls_client",
            new=sls_client,
        ):
            from prowler.providers.alibabacloud.services.sls.sls_alert_single_factor_logins.sls_alert_single_factor_logins import (
                sls_alert_single_factor_logins,
            )
    ...
    def test_alert_enabled_pass(self):
        ...
        alert_name = "test-single-factor-alert"
        ...
        with mock.patch(
            ...
            sls_client.alerts = {
                alert_arn: Alert(
                    name=alert_name,
                    display_name="Alert for Single-Factor Console Logins",
            ...
            assert "Single-Factor Console Logins" in result[0].status_extended
