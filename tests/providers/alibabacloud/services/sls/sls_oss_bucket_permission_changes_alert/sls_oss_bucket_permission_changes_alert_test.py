...
class Test_sls_alert_oss_bucket_permission_changes:
    def test_no_alerts(self):
        ...
        with mock.patch(
            ...
            "prowler.providers.alibabacloud.services.sls.sls_alert_oss_bucket_permission_changes.sls_alert_oss_bucket_permission_changes.sls_client",
            new=sls_client,
        ):
            from prowler.providers.alibabacloud.services.sls.sls_alert_oss_bucket_permission_changes.sls_alert_oss_bucket_permission_changes import (
                sls_alert_oss_bucket_permission_changes,
            )
    ...
    def test_alert_enabled_pass(self):
        ...
        alert_name = "test-oss-permission-alert"
        ...
        with mock.patch(
            ...
            sls_client.alerts = {
                alert_arn: Alert(
                    name=alert_name,
                    display_name="Alert for OSS Bucket Permission Changes",
            ...
            assert "OSS Bucket Permission Changes" in result[0].status_extended
