...
class Test_sls_root_account_logins_alert:
    def test_no_alerts(self):
        ...
        with mock.patch(
            ...
            "prowler.providers.alibabacloud.services.sls.sls_alert_root_account_logins.sls_alert_root_account_logins.sls_client",
            new=sls_client,
        ):
            from prowler.providers.alibabacloud.services.sls.sls_alert_root_account_logins.sls_alert_root_account_logins import (
                sls_alert_root_account_logins,
            )
    ...
    def test_alert_enabled_pass(self):
        ...
        alert_name = "test-root-login-alert"
        ...
        with mock.patch(
            ...
            sls_client.alerts = {
                alert_arn: Alert(
                    name=alert_name,
                    display_name="Alert for Root Account Logins",
            ...
            assert "Root Account Logins" in result[0].status_extended
