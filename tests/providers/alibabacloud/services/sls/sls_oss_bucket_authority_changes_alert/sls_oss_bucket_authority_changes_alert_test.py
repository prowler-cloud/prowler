...
class Test_sls_alert_oss_bucket_authority_changes:
    def test_no_alerts(self):
        ...
        with mock.patch(
            ...
            "prowler.providers.alibabacloud.services.sls.sls_alert_oss_bucket_authority_changes.sls_alert_oss_bucket_authority_changes.sls_client",
            new=sls_client,
        ):
            from prowler.providers.alibabacloud.services.sls.sls_alert_oss_bucket_authority_changes.sls_alert_oss_bucket_authority_changes import (
    ...
    def test_alert_enabled_pass(self):
        ...
        alert_name = "test-oss-authority-alert"
        ...
        with mock.patch(
            ...
            sls_client.alerts = {
                alert_arn: Alert(
                    name=alert_name,
                    display_name="Alert for OSS Bucket Authority Changes",
            ...
            assert "OSS Bucket Authority Changes" in result[0].status_extended
