...
class Test_sls_account_login_failures_alert:
    def test_no_alerts(self):
        ...
        with mock.patch(
            ...
            "prowler.providers.alibabacloud.services.sls.sls_alert_account_login_failures.sls_alert_account_login_failures.sls_client",
            new=sls_client,
        ):
            from prowler.providers.alibabacloud.services.sls.sls_alert_account_login_failures.sls_alert_account_login_failures import (
                sls_alert_account_login_failures,
            )
    ...
    def test_alert_enabled_pass(self):
        ...
        alert_name = "test-login-failure-alert"
        ...
        with mock.patch(
            ...
            sls_client.alerts = {
                alert_arn: Alert(
                    name=alert_name,
                    display_name="Alert for Account Login Failures",
            ...
            assert "Account Login Failures" in result[0].status_extended
