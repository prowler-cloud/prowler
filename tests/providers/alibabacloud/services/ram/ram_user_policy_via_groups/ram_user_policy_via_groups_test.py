...
class Test_ram_user_policy_via_groups:
    def test_no_users(self):
        ...
        with mock.patch(
            ...
            "prowler.providers.alibabacloud.services.ram.ram_user_policy_via_groups.ram_user_policy_via_groups.ram_client",
            new=ram_client,
        ):
            from prowler.providers.alibabacloud.services.ram.ram_user_policy_via_groups.ram_user_policy_via_groups import (
                ram_user_policy_via_groups,
            )
    ...
    def test_ram_user_policy_via_groups_pass(self):
        ram_client = mock.MagicMock
    ...
    def test_ram_user_policy_via_groups_fail(self):
        ram_client = mock.MagicMock
