...
class Test_ram_password_require_lowercase:
    def test_no_password_policy(self):
        ...
        with mock.patch(
            ...
            "prowler.providers.alibabacloud.services.ram.ram_password_require_lowercase.ram_password_require_lowercase.ram_client",
            new=ram_client,
        ):
            from prowler.providers.alibabacloud.services.ram.ram_password_require_lowercase.ram_password_require_lowercase import (
                ram_password_require_lowercase,
            )
    ...
    def test_password_policy_pass(self):
        ...
        with mock.patch(
            ...
            assert result[0].resource_id == "password-policy"
            assert "lowercase" in result[0].status_extended.lower()
