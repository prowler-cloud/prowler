...
class Test_oss_bucket_lifecycle_rules:
    def test_no_buckets(self):
        ...
        with mock.patch(
            ...
            "prowler.providers.alibabacloud.services.oss.oss_bucket_lifecycle_rules.oss_bucket_lifecycle_rules.oss_client",
            new=oss_client,
        ):
            from prowler.providers.alibabacloud.services.oss.oss_bucket_lifecycle_rules.oss_bucket_lifecycle_rules import (
                oss_bucket_lifecycle_rules,
            )
    ...
    def test_bucket_no_lifecycle_rules(self):
        oss_client = mock.MagicMock
        bucket_name = "test-bucket-no-lifecycle"
        bucket_arn = f"acs:oss:{ALIBABACLOUD_REGION}:{ALIBABACLOUD_ACCOUNT_ID}:bucket/{bucket_name}"
