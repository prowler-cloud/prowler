...
class Test_logging_log_metric_filter_and_alert_for_audit_configuration_changes_enabled:
    ...
    # Unexpected error: FIX THE CHECK
    # def test_log_metric_filters_and_alert_does_not_match(self):
    #     logging_client = MagicMock()
    #     monitoring_client = MagicMock()
    ...
    #                 enabled=True,
    #                 filters=[
    #                     'metric.type = "logging.googleapis.com/user/metric_name_2"',
    #                 ],
    #                 project_id=GCP_PROJECT_ID,
    #             )
    #         ]

    #         check = logging_log_metric_filter_and_alert_for_audit_configuration_changes_enabled()
    #         result = check.execute()
    #         assert len(result) == 1
    #         assert result[0].status == "FAIL"
    #         assert (
