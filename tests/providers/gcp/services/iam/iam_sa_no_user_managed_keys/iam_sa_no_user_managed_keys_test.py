...
class Test_iam_sa_no_user_managed_keys:
    ...
    def test_iam_sa_user_managed_keys(self):
        ...
        with (
            ...
            mock.patch(
                "prowler.providers.gcp.services.iam.iam_sa_no_user_managed_keys.iam_sa_no_user_managed_keys.monitoring_client",
    ...
    def test_iam_sa_mixed_keys(self):
        ...
        with (
            ...
            assert (
                result[0].status_extended
                == f"Account {iam_client.service_accounts[0].email} has user-managed keys. The user-managed key {iam_client.service_accounts[0].keys[1].name} was not used over the last 180 days."
            )
            ...
            assert result[1].resource_id in monitoring_client.sa_keys_metrics
