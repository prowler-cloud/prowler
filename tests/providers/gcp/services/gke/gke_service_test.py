...
class Test_GKE_Service:
    def test__get_service__(self):
        gke_client = GKE(set_mocked_gcp_provider())
    ...
    def test__get_clusters__(self):
        ...
        assert gke_client.clusters["cluster1_id"].service_account == "service_account1"
        ...
        assert gke_client.clusters["cluster2_id"].service_account == "service_account2"
