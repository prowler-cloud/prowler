...
class Test_mysql_flexible_server_ssl_connection_enabled:
    ...
    def test_mysql_connection_enabled(self):
        ...
        with (
            ...
            assert (
                ...
                == f"SSL connection is enabled for server {server_name} in subscription {AZURE_SUBSCRIPTION_DISPLAY}."
            )
    ...
    def test_mysql_ssl_connection_disabled(self):
        ...
        with (
            ...
            assert (
                result[0].status_extended
                == f"SSL connection is disabled for server {server_name} in subscription {AZURE_SUBSCRIPTION_DISPLAY}."
            )
    ...
    def test_mysql_ssl_connection_enabled_and_disabled(self):
        ...
        with (
            ...
            assert (
                result[0].status_extended
                == f"SSL connection is enabled for server {server_name_1} in subscription {AZURE_SUBSCRIPTION_DISPLAY}."
            )
            ...
            assert (
                ...
                == f"SSL connection is disabled for server {server_name_2} in subscription {AZURE_SUBSCRIPTION_DISPLAY}."
            )
