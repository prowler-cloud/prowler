...
class Test_mysql_tls_version_is_1_2:
    def test_mysql_no_subscriptions(self):
        mysql_client = mock.MagicMock
        mysql_client.servers = {}

        with mock.patch(
            "prowler.providers.azure.services.mysql.mysql_tls_version_is_1_2.mysql_tls_version_is_1_2.mysql_client",
            new=mysql_client,
        ):
            from prowler.providers.azure.services.mysql.mysql_tls_version_is_1_2.mysql_tls_version_is_1_2 import (
                mysql_tls_version_is_1_2,
            )

            check = mysql_tls_version_is_1_2()
    ...
    def test_mysql_tls_version_is_1_2(self):
