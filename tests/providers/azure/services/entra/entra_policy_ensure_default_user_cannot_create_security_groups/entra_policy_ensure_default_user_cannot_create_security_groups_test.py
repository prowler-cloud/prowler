...
class Test_entra_policy_ensure_default_user_cannot_create_security_groups:
    def test_entra_no_tenants(self):
        entra_client = mock.MagicMock
        entra_client.authorization_policy = {}

        with mock.patch(
            "prowler.providers.azure.services.entra.entra_policy_ensure_default_user_cannot_create_security_groups.entra_policy_ensure_default_user_cannot_create_security_groups.entra_client",
            new=entra_client,
        ):
            from prowler.providers.azure.services.entra.entra_policy_ensure_default_user_cannot_create_security_groups.entra_policy_ensure_default_user_cannot_create_security_groups import (
                entra_policy_ensure_default_user_cannot_create_security_groups,
            )

            check = entra_policy_ensure_default_user_cannot_create_security_groups()
