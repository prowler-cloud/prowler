...
class Test_entra_esure_there_are_less_than_five_global_admins:
    def test_entra_no_tenants(self):
        entra_client = mock.MagicMock

        with mock.patch(
            "prowler.providers.azure.services.entra.entra_esure_there_are_less_than_five_global_admins.entra_esure_there_are_less_than_five_global_admins.entra_client",
            new=entra_client,
        ):
            from prowler.providers.azure.services.entra.entra_esure_there_are_less_than_five_global_admins.entra_esure_there_are_less_than_five_global_admins import (
                entra_esure_there_are_less_than_five_global_admins,
            )

            entra_client.directory_roles = {}

            check = entra_esure_there_are_less_than_five_global_admins()
