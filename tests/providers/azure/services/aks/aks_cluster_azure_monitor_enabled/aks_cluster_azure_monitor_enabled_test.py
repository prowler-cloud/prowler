...
class Test_aks_cluster_azure_monitor_enabled:
    def test_no_subscriptions(self):
        ...
        with (
            ...
            mock.patch(
                "prowler.providers.azure.services.aks.aks_cluster_azure_monitor_enabled.aks_cluster_azure_monitor_enabled.aks_client",
                new=aks_client,
            ),
        ):
            from prowler.providers.azure.services.aks.aks_cluster_azure_monitor_enabled.aks_cluster_azure_monitor_enabled import (
