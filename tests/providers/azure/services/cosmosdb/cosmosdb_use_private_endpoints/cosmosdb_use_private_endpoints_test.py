...
class Test_cosmosdb_use_private_endpoints:
    def test_no_accounts(self):
        cosmosdb_client = mock.MagicMock
        cosmosdb_client.accounts = {}

        with mock.patch(
            "prowler.providers.azure.services.cosmosdb.cosmosdb_use_private_endpoints.cosmosdb_use_private_endpoints.cosmosdb_client",
            new=cosmosdb_client,
        ):
            from prowler.providers.azure.services.cosmosdb.cosmosdb_use_private_endpoints.cosmosdb_use_private_endpoints import (
                cosmosdb_use_private_endpoints,
            )

            check = cosmosdb_use_private_endpoints()
