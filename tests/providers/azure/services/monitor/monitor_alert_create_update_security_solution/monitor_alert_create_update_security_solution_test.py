...
class Test_monitor_alert_create_update_security_solution:
    ...
    def test_no_alert_rules(self):
        ...
        with mock.patch(
            ...
            assert (
                ...
                == f"There is not an alert for create securitySolutions in subscription {AZURE_SUBSCRIPTION}."
            )
    ...
    def test_alert_rules_configured(self):
        ...
        with mock.patch(
            ...
            assert (
                result[0].status_extended
                == f"There is an alert configured for create securitySolutions in subscription {AZURE_SUBSCRIPTION}."
            )
