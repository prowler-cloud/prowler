...
class Test_monitor_alert_create_policy_assignment:
    ...
    def test_no_alert_rules(self):
        ...
        with mock.patch(
            ...
            assert (
                ...
                == f"There is not an alert for Create Policy Assingment in subscription {AZURE_SUBSCRIPTION}."
            )
    ...
    def test_alert_rules_configured(self):
        ...
        with mock.patch(
            ...
            assert (
                result[0].status_extended
                == f"Alert name2 is configured to trigger when a policy assignment is created in subscription {AZURE_SUBSCRIPTION}."
            )
