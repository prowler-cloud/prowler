...
class Test_monitor_alert_delete_nsg:
    ...
    def test_no_alert_rules(self):
        ...
        with (
            ...
            assert (
                ...
                == f"There is not an alert for deleting Network Security Groups in subscription {AZURE_SUBSCRIPTION_DISPLAY}."
            )
    ...
    def test_alert_rules_configured(self):
        ...
        with (
            ...
            assert (
                result[0].status_extended
                == f"There is an alert configured for deleting Network Security Groups in subscription {AZURE_SUBSCRIPTION_DISPLAY}."
            )
