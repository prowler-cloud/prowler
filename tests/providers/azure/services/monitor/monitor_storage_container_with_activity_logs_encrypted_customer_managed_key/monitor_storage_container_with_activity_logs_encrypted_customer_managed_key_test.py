...
class Test_monitor_storage_container_with_activity_logs_encrypted_customer_managed_key:
    def test_monitor_storage_container_with_activity_logs_encrypted_customer_managed_key_no_subscriptions(
        self,
    ):
        ...
        with mock.patch(
            "prowler.providers.azure.services.monitor.monitor_storage_container_with_activity_logs_encrypted_customer_managed_key.monitor_storage_container_with_activity_logs_encrypted_customer_managed_key.monitor_client",
            new=monitor_client,
        ):
            from prowler.providers.azure.services.monitor.monitor_storage_container_with_activity_logs_encrypted_customer_managed_key.monitor_storage_container_with_activity_logs_encrypted_customer_managed_key import (
                monitor_storage_container_with_activity_logs_encrypted_customer_managed_key,
            )
    ...
    def test_no_diagnostic_settings(self):
        ...
        with mock.patch(
            ...
            assert (
                ...
                == f"Storage account storing activity log in subscription {AZURE_SUBSCRIPTION} is encrypted with Customer Managed Key or not necessary."
            )
    ...
    def test_diagnostic_settings_configured(self):
        ...
        with mock.patch(
            ...
            with mock.patch(
                "prowler.providers.azure.services.monitor.monitor_storage_container_with_activity_logs_encrypted_customer_managed_key.monitor_storage_container_with_activity_logs_encrypted_customer_managed_key.storage_client",
                new=storage_client,
            ):
                from prowler.providers.azure.services.monitor.monitor_storage_container_with_activity_logs_encrypted_customer_managed_key.monitor_storage_container_with_activity_logs_encrypted_customer_managed_key import (
                    monitor_storage_container_with_activity_logs_encrypted_customer_managed_key,
                ...
                assert (
                    result[0].status_extended
                    == f"Storage account storing activity log in subscription {AZURE_SUBSCRIPTION} is not encrypted with Customer Managed Key."
                )
