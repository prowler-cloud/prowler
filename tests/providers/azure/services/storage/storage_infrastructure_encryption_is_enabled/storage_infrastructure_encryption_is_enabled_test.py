...
class Test_storage_infrastructure_encryption_is_enabled:
    ...
    def test_storage_storage_accounts_infrastructure_encryption_disabled(self):
        ...
        with (
            ...
            assert (
                ...
                == f"Storage account {storage_account_name} from subscription {AZURE_SUBSCRIPTION_DISPLAY} has infrastructure encryption disabled."
            )
    ...
    def test_storage_storage_accounts_infrastructure_encryption_enabled(self):
        ...
        with (
            ...
            assert (
                result[0].status_extended
                == f"Storage account {storage_account_name} from subscription {AZURE_SUBSCRIPTION_DISPLAY} has infrastructure encryption enabled."
            )
            assert result[0].subscription == AZURE_SUBSCRIPTION_ID
            assert result[0].resource_name == storage_account_name
            assert result[0].resource_id == storage_account_id
