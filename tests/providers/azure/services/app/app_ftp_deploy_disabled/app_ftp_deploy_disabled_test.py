...
class Test_app_ftp_deploy_disabled:
    def test_app_no_subscriptions(self):
        app_client = mock.MagicMock
        app_client.apps = {}

        with mock.patch(
            "prowler.providers.azure.services.app.app_ftp_deploy_disabled.app_ftp_deploy_disabled.app_client",
            new=app_client,
        ):
            from prowler.providers.azure.services.app.app_ftp_deploy_disabled.app_ftp_deploy_disabled import (
                app_ftp_deploy_disabled,
            )

            check = app_ftp_deploy_disabled()
    ...
    def test_app_ftp_deploy_disabled(self):
        resource_id = f"/subscriptions/{uuid4()}"
        app_client = mock.MagicMock
        app_client.apps = {
            AZURE_SUBSCRIPTION: {
