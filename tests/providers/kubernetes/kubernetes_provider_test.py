...
class TestKubernetesProvider:
    ...
    def test_set_provider_output_options_kubernetes(self):
        ...
        arguments = Namespace(kubeconfig_file=None, context=None, only_logs=False)
        kubernetes_provider = KubernetesProvider(arguments)

        output_options = kubernetes_provider.output_options = arguments, {}

        assert isinstance(kubernetes_provider.output_options, KubernetesOutputOptions)
