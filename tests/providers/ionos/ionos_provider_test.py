...
class TestIonosProvider:
    ...
    def test_ionos_provider_init_with_env_vars(
        self, mock_datacenters_api, mock_load_config
    ):
        """Test initialization of IonosProvider using environment variables"""
        # Mock config and API responses
        mock_load_config.return_value = {}
        mock_datacenters_api.return_value.datacenters_get.return_value = (
            self.mock_response
        )
    ...
    @patch("prowler.providers.ionos.ionos_provider.load_and_validate_config_file")
    @patch("prowler.providers.ionos.ionos_provider.DataCentersApi")
    def test_ionos_provider_init_with_credentials(
        self, mock_datacenters_api, mock_load_config
    ):
        ...
        mock_datacenters_api.return_value.datacenters_get.return_value.items = [
            mock_datacenter
        ]
    ...
    @patch("prowler.providers.ionos.ionos_provider.DataCentersApi")
    @patch("prowler.providers.ionos.ionos_provider.load_and_validate_config_file")
    def test_setup_identity_with_username_password(
        self, mock_load_config, mock_datacenters_api, mock_api_client
    ):
    ...
    @patch("prowler.providers.ionos.ionos_provider.DataCentersApi")
    @patch("prowler.providers.ionos.ionos_provider.load_and_validate_config_file")
    def test_setup_identity_with_token(
        self, mock_load_config, mock_datacenters_api, mock_api_client
    ):
