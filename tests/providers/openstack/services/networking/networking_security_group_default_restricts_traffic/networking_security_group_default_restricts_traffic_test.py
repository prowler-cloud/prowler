...
class Test_networking_security_group_default_restricts_traffic:
    ...
    def test_no_security_groups(self):
        ...
        with (
            ...
            mock.patch(
                "prowler.providers.openstack.services.networking.networking_security_group_default_restricts_traffic.networking_security_group_default_restricts_traffic.networking_client",
                new=network_client,
            ),
        ):
            from prowler.providers.openstack.services.networking.networking_security_group_default_restricts_traffic.networking_security_group_default_restricts_traffic import (
                networking_security_group_default_restricts_traffic,
            )

            check = networking_security_group_default_restricts_traffic()
