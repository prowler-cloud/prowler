...
class Test_repository_sensitive_data_scanner_enabled:
    ...
    def test_one_repository_no_secret_scanning(self):
        ...
        with (
            ...
            assert (
                ...
                == f"Repository {repo_full_name} does not have secret scanning enabled to detect sensitive data."
            )
    ...
    def test_one_repository_with_secret_scanning(self):
        ...
        with (
            ...
            assert (
                result[0].status_extended
                == f"Repository {repo_full_name} has secret scanning enabled to detect sensitive data."
            )
