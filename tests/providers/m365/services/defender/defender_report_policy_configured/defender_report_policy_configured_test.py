...
class Test_defender_report_policy_configured:
    def test_report_policy_configured_pass(self):
        ...
        with (
            ...
            mock.patch(
                "prowler.providers.m365.services.defender.defender_report_policy_configured.defender_report_policy_configured.defender_client",
                new=defender_client,
            ),
        ):
            from prowler.providers.m365.services.defender.defender_report_policy_configured.defender_report_policy_configured import (
                defender_report_policy_configured,
            )

            check = defender_report_policy_configured()
