...
class Test_entra_admin_mfa_enabled_for_administrative_roles:
    def test_no_conditional_access_policies(self):
        ...
        with (
            ...
            mock.patch(
                "prowler.providers.m365.services.entra.entra_admin_mfa_enabled_for_administrative_roles.entra_admin_mfa_enabled_for_administrative_roles.entra_client",
                new=entra_client,
            ),
        ):
            from prowler.providers.m365.services.entra.entra_admin_mfa_enabled_for_administrative_roles.entra_admin_mfa_enabled_for_administrative_roles import (
