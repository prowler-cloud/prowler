...
class Test_entra_admin_portals_role_limited_access:
    def test_entra_no_conditional_access_policies(self):
        ...
        with (
            ...
            mock.patch(
                "prowler.providers.m365.services.entra.entra_admin_portals_role_limited_access.entra_admin_portals_role_limited_access.entra_client",
                new=entra_client,
            ),
        ):
            from prowler.providers.m365.services.entra.entra_admin_portals_role_limited_access.entra_admin_portals_role_limited_access import (
