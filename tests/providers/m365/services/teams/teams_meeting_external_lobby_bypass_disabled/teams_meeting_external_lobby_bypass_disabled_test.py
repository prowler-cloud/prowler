...
class Test_teams_meeeting_external_lobby_bypass_disabled:
    def test_no_global_meeting_policy(self):
        ...
        with (
            ...
            mock.patch(
                "prowler.providers.m365.services.teams.teams_meeeting_external_lobby_bypass_disabled.teams_meeeting_external_lobby_bypass_disabled.teams_client",
                new=teams_client,
            ),
        ):
            from prowler.providers.m365.services.teams.teams_meeeting_external_lobby_bypass_disabled.teams_meeeting_external_lobby_bypass_disabled import (
                teams_meeeting_external_lobby_bypass_disabled,
            )

            check = teams_meeeting_external_lobby_bypass_disabled()
