...
class Test_firewall_outbound_rules_configured:
    def test_no_firewalls(self):
        ...
        with (
            ...
            mock.patch(
                "prowler.providers.linode.services.firewall.firewall_outbound_rules_configured.firewall_outbound_rules_configured.firewall_client",
                new=firewall_client,
            ),
        ):
            from prowler.providers.linode.services.firewall.firewall_outbound_rules_configured.firewall_outbound_rules_configured import (
                firewall_outbound_rules_configured,
            )

            check = firewall_outbound_rules_configured()
