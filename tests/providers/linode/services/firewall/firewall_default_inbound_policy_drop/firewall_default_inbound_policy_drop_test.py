...
class Test_firewall_default_inbound_policy_drop:
    def test_no_firewalls(self):
        ...
        with (
            ...
            mock.patch(
                "prowler.providers.linode.services.firewall.firewall_default_inbound_policy_drop.firewall_default_inbound_policy_drop.firewall_client",
                new=firewall_client,
            ),
        ):
            from prowler.providers.linode.services.firewall.firewall_default_inbound_policy_drop.firewall_default_inbound_policy_drop import (
                firewall_default_inbound_policy_drop,
            )

            check = firewall_default_inbound_policy_drop()
