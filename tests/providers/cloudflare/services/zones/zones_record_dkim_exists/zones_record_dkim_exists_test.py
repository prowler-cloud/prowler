...
class Test_zones_record_dkim_exists:
    def test_no_zones(self):
        ...
        with (
            ...
            mock.patch(
                "prowler.providers.cloudflare.services.zones.zones_record_dkim_exists.zones_record_dkim_exists.zones_client",
                new=zones_client,
            ),
            mock.patch(
                "prowler.providers.cloudflare.services.zones.zones_record_dkim_exists.zones_record_dkim_exists.dns_client",
                new=dns_client,
            ),
        ):
            from prowler.providers.cloudflare.services.zones.zones_record_dkim_exists.zones_record_dkim_exists import (
                zones_record_dkim_exists,
            )

            check = zones_record_dkim_exists()
