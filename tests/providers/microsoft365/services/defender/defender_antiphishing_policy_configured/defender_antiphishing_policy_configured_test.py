...
class Test_defender_antiphishing_policy_configured:
    def test_properly_configured_custom_policy(self):
        ...
        with (
            ...
            mock.patch(
                "prowler.providers.microsoft365.services.defender.defender_antiphishing_policy_configured.defender_antiphishing_policy_configured.defender_client",
                new=defender_client,
            ),
        ):
            from prowler.providers.microsoft365.services.defender.defender_antiphishing_policy_configured.defender_antiphishing_policy_configured import (
