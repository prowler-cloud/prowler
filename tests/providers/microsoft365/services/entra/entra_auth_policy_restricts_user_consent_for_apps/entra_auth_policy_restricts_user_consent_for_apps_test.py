...
class Test_entra_auth_policy_restricts_user_consent_for_apps:
    def test_entra_empty_policy(self):
        ...
        with (
            ...
            mock.patch(
                "prowler.providers.microsoft365.services.entra.entra_auth_policy_restricts_user_consent_for_apps.entra_auth_policy_restricts_user_consent_for_apps.entra_client",
                new=entra_client,
            ),
        ):
            from prowler.providers.microsoft365.services.entra.entra_auth_policy_restricts_user_consent_for_apps.entra_auth_policy_restricts_user_consent_for_apps import (
                entra_auth_policy_restricts_user_consent_for_apps,
            )

            check = entra_auth_policy_restricts_user_consent_for_apps()
