...
class Test_entra_organization_admin_consent_workflow_enabled:
    def test_admin_consent_enabled(self):
        ...
        with (
            ...
            mock.patch(
                "prowler.providers.microsoft365.services.entra.entra_organization_admin_consent_workflow_enabled.entra_organization_admin_consent_workflow_enabled.entra_client",
                new=entra_client,
            ),
        ):
            from prowler.providers.microsoft365.services.entra.entra_organization_admin_consent_workflow_enabled.entra_organization_admin_consent_workflow_enabled import (
                entra_organization_admin_consent_workflow_enabled,
            )
            ...
            check = entra_organization_admin_consent_workflow_enabled()
