...
class Test_entra_ca_policy_mfa_enabled_for_all_users:
    def test_no_conditional_access_policies(self):
        ...
        with (
            ...
            mock.patch(
                "prowler.providers.microsoft365.services.entra.entra_ca_policy_mfa_enabled_for_all_users.entra_ca_policy_mfa_enabled_for_all_users.entra_client",
                new=entra_client,
            ),
        ):
            from prowler.providers.microsoft365.services.entra.entra_ca_policy_mfa_enabled_for_all_users.entra_ca_policy_mfa_enabled_for_all_users import (
                entra_ca_policy_mfa_enabled_for_all_users,
            )

            entra_client.conditional_access_policies = {}

            check = entra_ca_policy_mfa_enabled_for_all_users()
