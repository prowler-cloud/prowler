...
class Test_entra_auth_policy_guest_users_access_restrictions:
    def test_no_auth_policy(self):
        ...
        with (
            ...
            mock.patch(
                "prowler.providers.microsoft365.services.entra.entra_auth_policy_guest_users_access_restrictions.entra_auth_policy_guest_users_access_restrictions.entra_client",
                new=entra_client,
            ),
        ):
            from prowler.providers.microsoft365.services.entra.entra_auth_policy_guest_users_access_restrictions.entra_auth_policy_guest_users_access_restrictions import (
                entra_auth_policy_guest_users_access_restrictions,
            )

            check = entra_auth_policy_guest_users_access_restrictions()
