...
class Test_entra_capolicy_managed_device_required_for_mfa_registration:
    def test_entra_no_conditional_access_policies(self):
        ...
        with (
            ...
            mock.patch(
                "prowler.providers.microsoft365.services.entra.entra_capolicy_managed_device_required_for_mfa_registration.entra_capolicy_managed_device_required_for_mfa_registration.entra_client",
                new=entra_client,
            ),
        ):
            from prowler.providers.microsoft365.services.entra.entra_capolicy_managed_device_required_for_mfa_registration.entra_capolicy_managed_device_required_for_mfa_registration import (
                entra_capolicy_managed_device_required_for_mfa_registration,
            )

            entra_client.conditional_access_policies = {}

            check = entra_capolicy_managed_device_required_for_mfa_registration()
