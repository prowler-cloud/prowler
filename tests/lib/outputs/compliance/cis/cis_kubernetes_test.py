...
class TestKubernetesCIS:
    def test_output_transform(self):
        ...
        assert output_data.ClusterUID == KUBERNETES_CLUSTER_NAME
        ...
        assert output_data_manual.ClusterUID == ""
