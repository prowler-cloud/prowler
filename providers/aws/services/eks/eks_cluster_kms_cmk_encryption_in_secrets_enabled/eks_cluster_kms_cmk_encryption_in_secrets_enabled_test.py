...
class Test_eks_cluster_kms_cmk_encryption_in_secrets_enabled:
    def test_no_clusters(self):
        ...
        with mock.patch(
            ...
            from providers.aws.services.eks.eks_cluster_kms_cmk_encryption_in_secrets_enabled.eks_cluster_kms_cmk_encryption_in_secrets_enabled import (
    ...
    def test_not_secrets_encryption(self):
        ...
        with mock.patch(
            ...
            assert search(
                "is not configured for EKS cluster", result[0].status_extended
            )
