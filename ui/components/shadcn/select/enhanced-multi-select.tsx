...
const multiSelectVariants = cva("m-1 transition-all duration-300 ease-in-out", {
  variants: {
    variant: {
      default:
        "text-bg-button-secondary border-slate-300 bg-slate-100 dark:border-slate-600 dark:bg-slate-800",
      secondary:
        "text-bg-button-secondary border-slate-300 bg-slate-200 dark:border-slate-600 dark:bg-slate-700",
      destructive: "text-text-error border-destructive bg-destructive/10",
      inverted:
        "border-border-input-primary bg-bg-input-primary text-bg-button-secondary",
    },
    badgeAnimation: {
      bounce: "",
      pulse: "",
...
interface MultiSelectOption {
  ...
  label: string;
  /** Optional secondary text shown in the dropdown list item. */
  description?: string;
...
export const EnhancedMultiSelect = React.forwardRef<
  MultiSelectRef,
  MultiSelectProps
>(
  (
    ...
    const getBadgeAnimationClass = () => {
      if (animationConfig?.badgeAnimation) {
        switch (animationConfig.badgeAnimation) {
          ...
          case "wiggle":
            return isAnimating ? "animate-wiggle" : "";
          case "fade":
            return isAnimating ? "opacity-80" : "";
          case "slide":
            return isAnimating ? "translate-x-1" : "";
          case "none":
            return "";
          default:
            return "";
      ...
      <>
        ...
        >
                    ...
                    {selectedValues.length > responsiveSettings.maxCount && (
                      ...
                      >
                        ...
                        <span
                          ...
                          className={cn(
                            "ml-2 inline-flex h-4 w-4 shrink-0 cursor-pointer items-center justify-center self-center rounded-sm",
          ...
          <PopoverContent
            ...
            className={cn(
              "border-border-input-primary bg-bg-input-primary text-bg-button-secondary pointer-events-auto !z-[2147483647] w-[var(--radix-popover-trigger-width)] max-w-[var(--radix-popover-trigger-width)] rounded-lg p-0",
          ...
          >
            <Command>
              ...
              <CommandList
                className={cn(
                  "minimal-scrollbar multiselect-scrollbar max-h-[40vh] overflow-x-hidden overflow-y-auto",
          ...
          {animation > 0 && selectedValues.length > 0 && (
            <WandSparkles
              className={cn(
                "text-bg-button-secondary bg-bg-input-primary my-2 h-3 w-3 cursor-pointer",
                isAnimating ? "" : "text-bg-button-secondary/70",
              )}
