  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-[8px] text-sm font-medium transition-all disabled:pointer-events-none disabled:bg-button-disabled disabled:text-text-neutral-tertiary outline-none focus-visible:ring-2 focus-visible:ring-offset-2 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        link: "text-button-tertiary underline-offset-4 hover:text-button-tertiary-hover disabled:bg-transparent disabled:cursor-not-allowed disabled:opacity-60 disabled:hover:no-underline",
        ...
        "bare-success":
          "border-0 bg-transparent p-0 text-text-success-primary opacity-80 hover:text-text-success-primary hover:opacity-100 active:text-text-success-primary focus-visible:ring-border-neutral-secondary/50 disabled:bg-transparent disabled:opacity-60",
      ...
      size: {
        ...
        "link-xs": "text-xs",
        "link-sm": "text-sm",
        "link-inline": "h-auto min-w-0 gap-1.5 p-0 text-sm",
      },
    },
    defaultVariants: {
      variant: "default",
