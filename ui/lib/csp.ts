...
export function getCspHeader({
  ...
  img-src 'self' https://www.google-analytics.com https://www.googletagmanager.com https://media.registry.prowler.com https://media.registry.dev.prowler.com${posthogSource}${toolbarUiSource};
