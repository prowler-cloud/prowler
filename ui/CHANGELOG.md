...
- Finding detail drawer reorganized: status-extended banner above the resource info colored by finding status, dedicated Remediation tab, IDs moved to the end of Finding Overview, asymmetric Account/Resource grid, and inline View Resource link next to the resource UID [(#TBD)](https://github.com/prowler-cloud/prowler/pull/TBD)
