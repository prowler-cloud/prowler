...
- Fixed hydration warning caused by invalid button nesting in `DownloadIconButton` on Compliance and Scan pages. [(#7998)](https://github.com/prowler-cloud/prowler/pull/7998)
