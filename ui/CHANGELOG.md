...
- Table pagination controls now keep their arrows visible on hover in light theme, and Cloud Providers uses the same spacing between filters and table as the rest of the app
