...
- Attack Paths graph nodes now wrap long resource and finding labels, indicate truncated values with `…`, and show the full value in an immediate tooltip [(#TBD)](https://github.com/prowler-cloud/prowler/pull/TBD)
