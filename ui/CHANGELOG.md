...
- Attack Paths custom openCypher queries now use a Lighthouse-themed code editor with syntax highlighting, line numbers, and a read-only requirement badge
