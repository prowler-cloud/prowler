...
- `cryptography` from 46.0.1 to 47.0.0 (transitive), patching CVE-2026-39892 (out-of-bounds read on non-contiguous buffers in `Hash.update()` and similar APIs) and earlier CVE-2026-26007 / CVE-2026-34073
