...
The inventory will be stored in an output `csv` file by default, under `/output` folder, with the following format: `prowler-inventory-${ACCOUNT_NUM}-${OUTPUT_DATE}.csv`
