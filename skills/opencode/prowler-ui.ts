...
- Creating components with shadcn/ui (NEVER use HeroUI for new components)
...
## Keywords
prowler ui, next.js, react 19, tailwind 4, shadcn, playwright, zod 4, zustand 5
`;
...
- shadcn/ui (ALWAYS use) | HeroUI (LEGACY - never add new)
