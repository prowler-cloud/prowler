...
- **NEVER**: Use HeroUI (`components/ui/` is legacy, do NOT add new components there)
...
│   └── scans/
├── components/
│   ├── shadcn/              # shadcn/ui components (USE THIS)
│   └── ui/                  # HeroUI (LEGACY - do not add here)
...
## Keywords
prowler ui, next.js, react 19, tailwind 4, shadcn
