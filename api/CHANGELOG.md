...
- Add `/api/v1/resources/{id}/timeline` to track resource modification history (who changed what, when) for AWS resources [(#9250)](https://github.com/prowler-cloud/prowler/pull/9250)
