...
- Attack Paths: `Accpet` header query endpoints also accepts `text/plain`, supporting compact plain-text formator LLM consumption [(#10162)](https://github.com/prowler-cloud/prowler/pull/10162)
