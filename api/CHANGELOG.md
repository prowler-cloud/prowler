...
- Resource `name` is now stored and refreshed on every scan, so resources no longer keep an empty name [(#11937)](https://github.com/prowler-cloud/prowler/pull/11937)
