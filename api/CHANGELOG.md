...
- Attack Paths: Added tenand and provider related labels to the nodes so they can be easy filtered on custom queries [(#10308)](https://github.com/prowler-cloud/prowler/pull/10308)
