...
- Worker-beat race condition on cold start: replaced `sleep 15` with API service healthcheck dependency so beat waits for migrations to complete [(#10603)](https://github.com/prowler-cloud/prowler/pull/10603)
