...
EXAMPLES_DIR = (
    Path(__file__).parent.parent.parent.parent.parent.parent / "examples" / "output"
)
...
def create_real_prowler_csv_data(
    ...
    row1_fields = [
        ...
        "IAM",
        "FAIL",
        f"IAM Access Analyzer in account {account_uid} is not enabled.",
        "False",
        "accessanalyzer",
        "",
        "low",
    ...
    row2_fields = [
        ...
        "S3",
        "PASS",
        "S3 bucket test-bucket has public access block enabled.",
        "False",
        "s3",
        "",
        "informational",
        ...
        "aws",
        "us-west-2",
        "Check if S3 buckets have public access block enabled",
    ...
    row3_fields = [
        ...
        "EC2 Instance IMDSv2 Check",
        "EC2",
        "PASS",
        "EC2 instance has IMDSv2 enabled.",
        "False",
        "ec2",
        "",
        "informational",
...
class TestScanImportWithRealProwlerCSV:
    ...
    def test_import_real_prowler_csv_creates_scan_and_findings(
        ...
        csv_data = create_real_prowler_csv_data(
            account_uid=account_uid, account_name="Real CSV Test Account"
        )
    ...
    def test_import_example_aws_csv_file(self, authenticated_client, tenants_fixture):
