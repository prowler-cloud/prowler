...
AWS_INTERNET_EXPOSED_EC2_SENSITIVE_S3_ACCESS = AttackPathsQueryDefinition(
    ...
    provider="aws",
    cypher=f"""
        CALL apoc.create.vNode(['Internet'], {{id: 'Internet', name: 'Internet', {PROVIDER_ID_PROPERTY}: $provider_id}})
        ...
        CALL apoc.create.vRelationship(internet, 'CAN_ACCESS', {{{PROVIDER_ID_PROPERTY}: $provider_id}}, ec2)
...
AWS_CLASSIC_ELB_INTERNET_EXPOSED = AttackPathsQueryDefinition(
    ...
    cypher=f"""
        ...
        CALL apoc.create.vRelationship(internet, 'CAN_ACCESS', {{{PROVIDER_ID_PROPERTY}: $provider_id}}, elb)
        YIELD rel AS can_access
...
AWS_ELBV2_INTERNET_EXPOSED = AttackPathsQueryDefinition(
    ...
    cypher=f"""
        ...
        CALL apoc.create.vRelationship(internet, 'CAN_ACCESS', {{{PROVIDER_ID_PROPERTY}: $provider_id}}, elbv2)
        YIELD rel AS can_access
...
AWS_PUBLIC_IP_RESOURCE_LOOKUP = AttackPathsQueryDefinition(
    ...
    cypher=f"""
        ...
        CALL apoc.create.vRelationship(internet, 'CAN_ACCESS', {{{PROVIDER_ID_PROPERTY}: $provider_id}}, x)
        YIELD rel AS can_access
