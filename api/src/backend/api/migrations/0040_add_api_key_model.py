        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "method",
                    models.CharField(
                        max_length=10, help_text="HTTP method (GET, POST, etc.)"
                    ),
                ),
                (
                    "endpoint",
                ...
                (
                    ...
                    models.GenericIPAddressField(
                        db_index=True, help_text="Source IP address of the request"
                    ),
                ),
                (
                    "user_agent",
                ...
                (
                    "response_size",
                    models.IntegerField(
                        blank=True, null=True, help_text="Size of the response in bytes"
                    ),
                ),
                (
                    "duration_ms",
                ...
                (
                    ...
                    models.ForeignKey(
                        blank=True,
                        null=True,
                        help_text="User who owns the API key (optional for API key authentication)",
