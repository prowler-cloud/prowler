...
@extend_schema_view(
    ...
    retrieve=extend_schema(
        tags=["Provider"],
        summary="Retrieve data from specific provider",
        description="Fetch detailed information about a specific provider by their Prowler provider ID (UUIDv4 generated by Prowler).",
    ),
    create=extend_schema(
        tags=["Provider"],
        summary="Create new provider",
        description="Create a new provider in the current Prowler Tenant. A provider is any platform or service that offers resources, data, or functionality that can be security audited with Prowler.",
    ...
    destroy=extend_schema(
        ...
        description="Remove a configured provider from the Prowler Tenant by their Prowler provider ID (UUIDv4 generated by Prowler).",
...
class ProviderViewSet(BaseRLSViewSet):
    ...
    @extend_schema(
        ...
        description="Verify that the configured provider secret can successfully establish a connection to the actual provider endpoints.",
        request=None,
        parameters=[
            OpenApiParameter(
                name="id",
...
@extend_schema_view(
    list=extend_schema(
        tags=["Provider"],
        summary="List all provider secrets",
        description="List all provider secrets in the current Prowler Tenant with options for filtering by various criteria",
    ),
    retrieve=extend_schema(
        tags=["Provider"],
        summary="Retrieve data from a specific provider secret",
        description="Fetch detailed information about a specific provider secret by their Prowler provider secret ID (UUIDv4 generated by Prowler).",
    ),
    create=extend_schema(
        tags=["Provider"],
        summary="Add provider secret",
        description="Add a new provider secret to an existing provider in the current Prowler Tenant.",
    ...
    destroy=extend_schema(
        ...
        description="Remove a configured provider secret from the Prowler Tenant by their Prowler provider secret ID (UUIDv4 generated by Prowler).",
