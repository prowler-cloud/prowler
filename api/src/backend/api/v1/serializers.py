...
class ResourceEventSerializer(drf_serializers.Serializer):
    ...
    actor_type = drf_serializers.CharField(allow_null=True, required=False)
    ...
    request_data = drf_serializers.JSONField(allow_null=True, required=False)
    response_data = drf_serializers.JSONField(allow_null=True, required=False)
