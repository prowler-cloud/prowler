...
DJANGO_OUTPUT_AWS_S3_OUTPUT_BUCKET = env.str("DJANGO_OUTPUT_AWS_S3_OUTPUT_BUCKET", "")
DJANGO_OUTPUT_AWS_ACCESS_KEY_ID = env.str("DJANGO_OUTPUT_AWS_ACCESS_KEY_ID", "")
DJANGO_OUTPUT_AWS_SECRET_ACCESS_KEY = env.str("DJANGO_OUTPUT_AWS_SECRET_ACCESS_KEY", "")
DJANGO_OUTPUT_AWS_SESSION_TOKEN = env.str("DJANGO_OUTPUT_AWS_SESSION_TOKEN", "")
DJANGO_OUTPUT_AWS_DEFAULT_REGION = env.str("DJANGO_OUTPUT_AWS_DEFAULT_REGION", "")
