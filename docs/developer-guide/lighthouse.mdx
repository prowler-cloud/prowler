---
title: 'Extending Cignify AI'
---

This guide helps developers customize and extend Prowler Cignify AI by adding or modifying AI agents.
...
Prowler Cignify AI is an autonomous agent - selecting the right tool(s) based on the users query.
...
## Prowler Cignify AI Architecture

Prowler Cignify AI uses a multi-agent architecture orchestrated by the [Langgraph-Supervisor](https://www.npmjs.com/package/@langchain/langgraph-supervisor) library.

### Architecture Components

<img src="/images/prowler-app/lighthouse-architecture.png" alt="Prowler Lighthouse architecture" />

Prowler Cignify AI integrates with the NextJS application:
...
To add new capabilities or all Cignify AI to interact with other APIs, create additional specialized agents:
