...
For a complete list of checks that already support configuration, see the [Configuration File Tutorial](/user-guide/prowler-cli/tutorials/configuration-file).
