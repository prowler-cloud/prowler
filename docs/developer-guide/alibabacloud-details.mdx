...
The following Alibaba Cloud services are currently implemented:

| Service | Description |
|---------|-------------|
| `actiontrail` | Alibaba Cloud ActionTrail for audit logging |
| `cs` | Container Service for Kubernetes (ACK) |
| `ecs` | Elastic Compute Service |
| `oss` | Object Storage Service |
| `ram` | Resource Access Management |
| `rds` | Relational Database Service |
| `securitycenter` | Security Center (Cloud Security) |
