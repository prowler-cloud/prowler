...
| vercel_hobby_plan       | Vercel checks whose audited feature is available on the Hobby plan (and therefore also on Pro and Enterprise plans)                                                                                   |
| vercel_pro_plan         | Vercel checks whose audited feature requires a Pro plan or higher, including features also available on Enterprise or via supported paid add-ons for Pro plans                                        |
| vercel_enterprise_plan  | Vercel checks whose audited feature requires the Enterprise plan                                                                                                                                    |
