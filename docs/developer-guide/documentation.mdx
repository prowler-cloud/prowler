...
- **Getting Started**: Provides an overview of the Prowler platform and its different solutions, including Prowler Cloud/App, Prowler CLI, Prowler MCP Server, Prowler Hub, and Prowler Cignify AI. This section helps new users understand which Prowler solution best fits their needs and includes product comparisons.
