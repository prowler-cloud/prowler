...
<Tabs>
  ...
  <Tab title="Claude Code (CLI)">
    ...
    <Warning>
    **This applies to the Claude Code CLI**, and to the **Code tab** of the Claude desktop app, which reads the same `~/.claude.json`. It does **not** apply to the app's **Chat** tab, claude.ai, or Claude mobile — those surfaces use connectors and cannot see servers added this way. See the [Claude app guide](/user-guide/ai-agents/claude-code#which-claude-surfaces-work).
    </Warning>
