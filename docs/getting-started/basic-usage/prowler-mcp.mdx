...
To use Prowler Cloud or Prowler App (Self-Managed) features:

1. Log in to [Prowler Cloud](https://cloud.prowler.com) or your self-hosted Prowler App.
2. Navigate to your user profile.
3. Click **Create API Key** and configure the key settings.
