...
Prowler Cignify AI is a Cloud Security Analyst chatbot that helps you understand, prioritize, and remediate security findings in your cloud environments. It's designed to provide security expertise for teams without dedicated resources, acting as your 24/7 virtual cloud security analyst.

<img src="/images/prowler-app/lighthouse-intro.png" alt="Prowler Lighthouse" />

<Card title="Set Up Cignify AI" icon="rocket" href="/user-guide/tutorials/prowler-app-lighthouse#set-up">
  Learn how to configure Cignify AI with your preferred LLM provider
</Card>

## Capabilities

Prowler Cignify AI is designed to be your AI security team member, with capabilities including:
...
Cignify AI can provide additional context to help you understand the findings:
...
Prowler Cignify AI is powerful, but there are limitations:
...
- **Access limitations**: Cignify AI can only access data the logged-in user can view. If you can't see certain information, Cignify AI can't see it either.
- **NextJS session dependence**: If your Prowler application session expires or logs out, Cignify AI will error out. Refresh and log back in to continue.
...
If you encounter issues with Prowler Cignify AI or have suggestions for improvements, please [reach out through our Slack channel](https://goto.prowler.com/slack).

### What Data Is Shared to LLM Providers?

The following API endpoints are accessible to Prowler Cignify AI. Data from the following API endpoints could be shared with LLM provider depending on the scope of user's query:
...
Not all Prowler API endpoints are integrated with Cignify AI. They are intentionally excluded for the following reasons:
...
Cignify AI supports three providers:
