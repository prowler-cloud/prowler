...
Prowler ships two product families: Open Source projects you run yourself, and Prowler Products operated or licensed by the Prowler team. This page is the reference for every official name. If a page or blog post uses a former name, the [Former Names](#former-names) table maps it to the current one.
...
| Prowler SDK | Python library that powers Prowler CLI and Prowler Local Server. Part of the [prowler repository](https://github.com/prowler-cloud/prowler). |
