...
<Update label="v5.41.0" description="September 2, 2026">
  ...
  Read more in the [Import Findings documentation](https://docs.prowler.com/user-guide/tutorials/prowler-import-findings#using-the-prowler-app).
  ...
  ### 🛠️ Prowler MCP — Tool Failures Reported as Errors
