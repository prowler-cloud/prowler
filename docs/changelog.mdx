...
<Update label="v5.39.0" description="August 12, 2026">
  ...
  Read more in the [Prowler MCP tools documentation](https://docs.prowler.com/getting-started/basic-usage/prowler-mcp-tools).
  ...
  ![Attack Paths grouped graph ending in a code execution outcome node](/images/changelog/v5.39.0-attack-paths-grouped-graph.png)
