...
<Update label="v5.37.0" description="July 31, 2026">
  ...
  <Note>
  These tools are exposed only by the Cloud MCP Server at `https://mcp.prowler.com/mcp`, because they manage features that exist only in **Prowler Cloud**. A self-hosted Local MCP Server does not include them.
  </Note>
