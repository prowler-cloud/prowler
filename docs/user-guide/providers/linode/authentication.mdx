...
description: 'Authenticate Prowler to Linode with a read-only Personal Access Token provided through the LINODE_TOKEN environment variable to keep the secret safe.'
---
