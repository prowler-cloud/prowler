...
description: 'Onboard Linode to Prowler and scan compute, networking, user account security, and more for misconfigurations from Prowler Cloud or the Prowler CLI.'
---
