...
Prowler supports three authentication methods. Choose based on your use case:
...
The permissions below apply to **both Fine-Grained Personal Access Tokens and GitHub Apps** - they use the same permission model.
...
**We DO NOT recommend granting Write permissions:**
...
Configure these permissions when creating your GitHub App:
