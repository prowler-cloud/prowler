...
description: 'Configure GitHub authentication for Prowler using fine-grained personal access tokens, GitHub App credentials, or OAuth app tokens across Cloud and CLI.'
---
