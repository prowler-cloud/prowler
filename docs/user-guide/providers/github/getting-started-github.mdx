---
title: 'Getting Started With GitHub on Prowler'
description: 'Set up GitHub security scanning with Prowler across user repositories and organizations to review branch protection, MFA policies, and repo hardening.'
---
...
<CardGroup cols={2}>
  <Card title="Prowler Cloud & Local Server" icon="cloud" href="#prowler-cloud-and-prowler-local-server">
