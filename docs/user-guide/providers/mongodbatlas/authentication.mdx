...
description: 'Authenticate Prowler to MongoDB Atlas with HTTP Digest API key pairs and configure IP access list and organization-level permissions for security scans.'
---
