---
title: 'Getting Started with MongoDB Atlas on Prowler'
description: 'Onboard MongoDB Atlas to Prowler with organization ID and API key pair, then run security scans from Prowler Cloud or the Prowler CLI on your projects.'
---
