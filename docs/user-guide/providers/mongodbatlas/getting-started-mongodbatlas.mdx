...
Prowler supports MongoDB Atlas both from the CLI **(since v5.12.0)** and from Prowler App **(since v5.15.0)**. This guide walks you through the requirements, how to connect the provider in the UI, and how to run scans from the command line.
