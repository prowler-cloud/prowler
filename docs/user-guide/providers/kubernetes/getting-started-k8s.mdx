---
title: 'Getting Started with Kubernetes on Prowler'
description: 'Onboard Kubernetes clusters to Prowler and scan for security misconfigurations from Prowler Cloud or the Prowler CLI using your kubeconfig context.'
---
