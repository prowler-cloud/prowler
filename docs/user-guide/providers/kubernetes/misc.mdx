---
title: 'Kubernetes Context and Cluster Options in Prowler'
description: 'Filter Kubernetes contexts and clusters when running Prowler scans, including targeting specific kubeconfig contexts to audit only the desired cluster.'
---
