...
description: 'Scan targeted Google Cloud projects with Prowler --project-ids, use wildcard patterns, list accessible projects, and exclude projects from audits.'
---
