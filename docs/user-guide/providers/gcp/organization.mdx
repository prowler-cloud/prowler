---
title: 'Scan a Specific GCP Organization with Prowler'
description: 'Restrict Prowler GCP scans to one organization using --organization-id, with Cloud Asset API roles to enumerate projects across folders and subfolders.'
---
