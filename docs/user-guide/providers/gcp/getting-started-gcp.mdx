...
description: 'Onboard a Google Cloud project to Prowler Cloud: retrieve the GCP project ID, add the provider, and authenticate to start scanning your workloads.'
---
