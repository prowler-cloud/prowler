---
title: 'Installing PowerShell for the Microsoft 365 Provider'
description: 'Install PowerShell and the required modules to run the Prowler Microsoft 365 provider locally, including using --init-modules to bootstrap dependencies.'
---
