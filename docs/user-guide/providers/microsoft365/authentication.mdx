...
1. Go to Users > All Users > Click on the email for the user
    ...
    ![User Overview](/images/providers/user-info-page.png)

2. Click "Assigned Roles"

    ![User Roles](/images/providers/user-role-page.png)
...
3. Click "Add assignments", then search and select:
    ...
    ![Global Reader Screenshots](/images/providers/global-reader.png)

4. Click next, assign the role as "Active", and click "Assign"

    ![Grant Admin Consent for Role](/images/providers/grant-admin-consent-for-role.png)
