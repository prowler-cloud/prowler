...
description: 'Configure Microsoft 365 authentication for Prowler in Prowler Cloud or CLI, including app registrations, required Graph permissions, and PowerShell modules.'
---
