...
1. Access **Microsoft Entra ID**
    ...
    ![Overview of Microsoft Entra ID](../microsoft365//images/providers/microsoft-entra-id.png)

2. Navigate to "Applications" > "App registrations"

    ![App Registration nav](../microsoft365//images/providers/app-registration-menu.png)

3. Click "+ New registration", complete the form, and click "Register"

    ![New Registration](../microsoft365//images/providers/new-registration.png)

4. Go to "Certificates & secrets" > "Client secrets" > "+ New client secret"

    ![Certificate & Secrets nav](../microsoft365//images/providers/certificates-and-secrets.png)

5. Fill in the required fields and click "Add", then copy the generated value (this will be `AZURE_CLIENT_SECRET`)

    ![New Client Secret](../microsoft365//images/providers/new-client-secret.png)

#### Grant Microsoft Graph API Permissions

1. Go to App Registration > Select your Prowler App > click on "API permissions"

    ![API Permission Page](../microsoft365//images/providers/api-permissions-page.png)

2. Click "+ Add a permission" > "Microsoft Graph" > "Application permissions"

    ![Add API Permission](../microsoft365//images/providers/add-app-api-permission.png)
...
3. Search and select the required permissions:
    ...
    ![Permission Screenshots](../microsoft365//images/providers/directory-permission.png)

    ![Application Permissions](../microsoft365//images/providers/app-permissions.png)
...
1. **Add Exchange API:**
    ...
    ![Office 365 Exchange Online API](../microsoft365//images/providers/search-exchange-api.png)

    - Select "Exchange.ManageAsApp" permission and click "Add permissions"

    ![Exchange.ManageAsApp Permission](../microsoft365//images/providers/exchange-permission.png)

    - Assign `Global Reader` role to the app: Go to `Roles and administrators` > click `here` for directory level assignment

    ![Roles and administrators](../microsoft365//images/providers/here.png)

    - Search for `Global Reader` and assign it to your application

    ![Global Reader Role](../microsoft365//images/providers/global-reader-role.png)

2. **Add Teams API:**

    - Search and select "Skype and Teams Tenant Admin API" in **APIs my organization uses**

    ![Skype and Teams Tenant Admin API](../microsoft365//images/providers/search-skype-teams-tenant-admin-api.png)

    - Select "application_access" permission and click "Add permissions"

    ![application_access Permission](../microsoft365//images/providers/teams-permission.png)

3. Click "Grant admin consent for `<your-tenant-name>`" to grant admin consent

    ![Grant Admin Consent](../microsoft365//images/providers/grant-external-api-permissions.png)
...
1. Go to Users > All Users > Click on the email for the user
    ...
    ![User Overview](../microsoft365//images/providers/user-info-page.png)

2. Click "Assigned Roles"

    ![User Roles](../microsoft365//images/providers/user-role-page.png)
...
3. Click "Add assignments", then search and select:
    ...
    ![Global Reader Screenshots](../microsoft365//images/providers/global-reader.png)

4. Click next, assign the role as "Active", and click "Assign"

    ![Grant Admin Consent for Role](../microsoft365//images/providers/grant-admin-consent-for-role.png)
...
- `M365_USER` should be your Microsoft account email using the **assigned domain in the tenant**. This means it must look like `example@YourCompany.onmicrosoft.com` or `example@YourCompany.com`, but it must be the exact domain assigned to that user in the tenant.
    ...
    ![User Domains](/images/providers/user-domains.png)
