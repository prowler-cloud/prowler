...
description: 'Onboard a Microsoft 365 tenant to Prowler and scan Entra ID, Exchange, Teams, SharePoint, and more for security misconfigurations from Cloud or CLI.'
---
