---
title: 'Container Image Authentication in Prowler'
description: 'Authenticate Prowler to private container registries with basic credentials, registry tokens, or an existing docker login for Trivy-based image scans.'
---
