---
title: 'Getting Started with the Container Image Provider in Prowler'
description: 'Scan container images with Prowler and Trivy to detect vulnerabilities, exposed secrets, and misconfigurations, unified in standard Prowler reports.'
---
