...
6. To authenticate to private registries, optionally provide the [authentication](/user-guide/providers/image/authentication) details. To control which images are scanned, configure the following scan filters:
