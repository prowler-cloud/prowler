...
description: 'Configure OpenStack authentication for Prowler using a clouds.yaml file and a Reader-role user on public providers like OVH, Infomaniak, and Vexxhost.'
---
