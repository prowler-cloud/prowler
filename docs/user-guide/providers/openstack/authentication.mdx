...
<Tabs>
  ...
  <Tab title="Generic Public Cloud">
    ...
    <Note>
    Consult your provider's documentation for specific instructions on creating users and assigning roles. Add an issue or pull request adding the instructions for your provider.
    </Note>
