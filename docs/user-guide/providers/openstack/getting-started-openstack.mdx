...
4. Access to Prowler: CLI installed (see [Installation](/getting-started/installation/prowler-cli)) or Account created in [Prowler Cloud](https://cloud.prowler.com)
...
This is expected behavior and not an error, that's why those checks are not available in Prowler right now.
</Warning>
...
## OpensStack Additional Resources
