---
title: 'Getting Started With OpenStack on Prowler'
description: 'Onboard OpenStack public cloud providers to Prowler using clouds.yaml and run security scans of your infrastructure from Prowler Cloud or the Prowler CLI.'
---
