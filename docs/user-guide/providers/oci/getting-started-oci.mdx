---
title: 'Getting Started with OCI on Prowler'
description: 'Onboard your OCI tenancy to Prowler by gathering tenancy OCID, user OCID, API key fingerprint, and region, then scan from Prowler Cloud or the CLI.'
---
