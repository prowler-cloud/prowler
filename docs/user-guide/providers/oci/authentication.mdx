...
description: 'Set up OCI authentication for Prowler using config file sessions, manual API keys, instance principals inside compute, or supported environment variables.'
---
