...
| ACK / Kubernetes | OIDC IdP + RAM role + OIDC token file | [OIDC Role Authentication](#oidc-role-authentication-ackkubernetes) |
...
## OIDC Role Authentication (ACK/Kubernetes)
