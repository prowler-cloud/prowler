...
> **Security Note**: For security reasons, Prowler does NOT accept credentials via command-line arguments. All credentials must be provided via environment variables or the Alibaba Cloud credential chain.
