...
description: 'Onboard Google Workspace to Prowler and audit super admin hygiene, domain settings, and directory policies from Prowler Cloud or the Prowler CLI.'
---
