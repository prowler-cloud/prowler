...
description: 'Authenticate Prowler to Google Workspace using a service account with domain-wide delegation and the required read-only Admin SDK OAuth scopes.'
---
