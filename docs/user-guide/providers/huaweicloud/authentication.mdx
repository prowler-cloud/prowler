...
description: "Authenticate Prowler against Huawei Cloud with an IAM user's Access Key ID and Secret Access Key read from environment variables, no CLI flags."
---
