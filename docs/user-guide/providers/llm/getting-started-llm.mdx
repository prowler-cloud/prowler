---
title: 'Getting Started With the LLM Provider on Prowler'
description: 'Run LLM red team security testing with Prowler using promptfoo to evaluate large language models against prompt injection, jailbreaks, and more.'
---
