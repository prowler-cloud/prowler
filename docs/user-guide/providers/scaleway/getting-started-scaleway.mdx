...
description: 'Onboard Scaleway to Prowler and scan IAM resources for misconfigurations, including detecting API keys still owned by the account root user in your org.'
---
