...
description: 'Authenticate Prowler to Scaleway using an API key with the IAMReadOnly policy on a dedicated IAM user, configured through Scaleway environment variables.'
---
