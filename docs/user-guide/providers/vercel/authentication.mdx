...
description: 'Authenticate Prowler to Vercel using an API Token scoped to the target team with read-only access to projects, deployments, domains, and security settings.'
---
