...
description: 'Onboard Vercel to Prowler and scan teams and projects for deployment protection, env var exposure, WAF rules, domain configuration, and access controls.'
---
