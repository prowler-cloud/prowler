---
title: 'StackIT Authentication in Prowler'
description: 'Authenticate Prowler to StackIT with a service account key file so the StackIT SDK signs the RSA challenge and mints short-lived access tokens for scans.'
---
