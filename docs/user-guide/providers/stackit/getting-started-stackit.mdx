---
title: 'Getting Started With StackIT on Prowler'
description: 'Onboard StackIT to Prowler from the CLI using a service account key file and run security scans on your StackIT projects for misconfigurations at scale.'
---
