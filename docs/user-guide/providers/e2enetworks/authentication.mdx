...
description: 'Authenticate Prowler to the E2E Networks MyAccount API using an API key, auth token, and project ID passed via environment variables for safer scans.'
---
