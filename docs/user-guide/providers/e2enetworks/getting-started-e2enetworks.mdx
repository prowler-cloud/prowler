...
description: 'Onboard E2E Networks to Prowler and scan compute nodes, networking, security groups, load balancers, storage, and managed databases for misconfigurations.'
---
