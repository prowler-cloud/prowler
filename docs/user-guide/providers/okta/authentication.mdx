...
description: 'Authenticate Prowler to Okta as a service application using OAuth 2.0 with a private-key JWT, following DISA STIG least-privilege read-only scopes.'
---
