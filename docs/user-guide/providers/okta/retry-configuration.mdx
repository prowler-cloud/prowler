...
description: 'Tune Prowler Okta scans with proactive request throttling and reactive HTTP 429 retries driven by the X-Rate-Limit-Reset header from the Okta Python SDK.'
---
