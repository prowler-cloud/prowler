...
description: 'Onboard an Okta org to Prowler with a service app, private-key JWT, and least-privilege admin role to scan identity and session management policies.'
---
