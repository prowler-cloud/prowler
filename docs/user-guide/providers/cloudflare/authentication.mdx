...
description: 'Set up Cloudflare authentication for Prowler using a scoped API Token (recommended) or the legacy API Key and email, with required read-only permissions.'
---
