---
title: 'Getting Started with the IaC Provider in Prowler'
description: 'Scan Terraform, Kubernetes, Dockerfile, CloudFormation, and other IaC frameworks with Prowler using Trivy to catch misconfigurations before deployment.'
---
