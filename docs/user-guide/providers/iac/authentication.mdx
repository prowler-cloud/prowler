...
description: 'Configure IaC scanning in Prowler with no credentials for local paths, or a GitHub PAT, OAuth token, or Git URL to scan remote infrastructure code repos.'
---
