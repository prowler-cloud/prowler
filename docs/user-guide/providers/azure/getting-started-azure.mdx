...
description: 'Onboard an Azure subscription to Prowler Cloud: collect the subscription ID, create a service principal, and connect the Azure provider for scanning.'
---
