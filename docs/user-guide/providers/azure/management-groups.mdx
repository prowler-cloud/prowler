...
description: 'Use Azure Management Groups to grant Prowler read access across multiple Azure subscriptions through a single shared scope, with setup steps and links.'
---
