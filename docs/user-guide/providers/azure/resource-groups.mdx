---
title: 'Scope Prowler Scans to Azure Resource Groups'
description: 'Limit Azure security scans to specific resource groups with the Prowler --azure-resource-group flag across service principal, az CLI, and browser auth.'
---
