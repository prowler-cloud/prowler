...
description: 'Aggregate a universal compliance framework across every compatible provider with a completed scan in Prowler Cloud, and export a combined PDF report.'
---
