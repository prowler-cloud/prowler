...
<img src="/images/compliance/prowler-app-cross-provider-overview.png" alt="Cross-Provider Type Compliance overview showing the provider filters and the framework grid (CSA CCM, CIS Controls, DORA) with per-provider chips, scores, and failed/manual counts" width="900" />
