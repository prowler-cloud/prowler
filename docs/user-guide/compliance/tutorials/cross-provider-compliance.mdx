...
description: 'Aggregate a single-provider compliance framework across every provider of the same type in Prowler Cloud, and export a consolidated PDF report.'
---
