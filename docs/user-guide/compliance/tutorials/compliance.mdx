...
<img src="/images/compliance/prowler-app-compliance-detail-toolbar.png" alt="Top of a framework detail page showing the breadcrumb, scan info, level and region filters, and the CSV and PDF download buttons" width="900" />

Select any card to open the framework detail page, where the same scan, the same filters, and CSV / PDF download buttons stay one click away.
...
<img src="/images/compliance/prowler-app-compliance-detail-toolbar.png" alt="Top of a framework detail page showing the CSV and PDF download buttons in the header" width="900" />
