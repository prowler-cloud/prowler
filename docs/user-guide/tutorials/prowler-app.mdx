...
Select the cloud provider you want to scan and configure authentication credentials. Each provider has specific requirements and authentication methods.
