...
Attack Paths analyzes relationships between cloud resources, permissions, and security findings to identify privilege escalation chains and misconfigurations that could be exploited by threat actors.
...
Before using Attack Paths, ensure the following:
