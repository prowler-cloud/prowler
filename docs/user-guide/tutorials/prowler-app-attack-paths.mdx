---
title: "Prowler Attack Paths"
description: "Use graph-based analysis in Prowler App to detect privilege escalation chains, IAM misconfigurations, and exploitable relationships across AWS resources."
---
