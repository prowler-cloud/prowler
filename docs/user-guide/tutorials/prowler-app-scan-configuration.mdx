---
title: 'Prowler Scan Configuration'
description: 'Override per-provider check thresholds, allowed values, and retention windows in Prowler Cloud through Scan Configurations layered over the default config.'
---
