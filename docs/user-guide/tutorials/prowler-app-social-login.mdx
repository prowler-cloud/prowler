---
title: 'Social Login in Prowler App'
description: 'Enable Google and GitHub OAuth authentication in Prowler App by configuring the required environment variables for self-hosted social sign-in flows.'
---
