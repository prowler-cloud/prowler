...
![Add provider](/images/prowler-app/mutelist-ui-1.png)
3. Add a provider, then "Configure Muted Findings" button will be enabled in providers page and scans page
![Button enabled in providers page](/images/prowler-app/mutelist-ui-2.png)
![Button enabled in scans pages](/images/prowler-app/mutelist-ui-3.png)


## Step 2: Configure Mutelist

1. Open the modal by clicking "Configure Muted Findings" button
![Open modal](/images/prowler-app/mutelist-ui-4.png)
1. Provide a valid Mutelist in `YAML` format. More details about Mutelist [here](/user-guide/prowler-cli/tutorials/mutelist)
![Valid YAML configuration](/images/prowler-app/mutelist-ui-5.png)
If the YAML configuration is invalid, an error message will be displayed
![Wrong YAML configuration](/images/prowler-app/mutelist-ui-7.png)
![Wrong YAML configuration 2](/images/prowler-app/mutelist-ui-8.png)

## Step 3: Review the Mutelist

1. Once added, the configuration can be removed or updated
![Remove or update configuration](/images/prowler-app/mutelist-ui-6.png)

## Step 4: Check muted findings in the scan results

1. Run a new scan
2. Check the muted findings in the scan results
![Check muted fidings](/images/prowler-app/mutelist-ui-9.png)
