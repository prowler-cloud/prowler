---
title: 'Prowler App API Keys'
description: 'Create, manage, and revoke Prowler App API keys for automation, CI/CD pipelines, and third-party integrations with long-lived, RBAC-scoped access.'
---
