...
description: 'Discover every Azure subscription under your Entra tenant management groups and onboard the ones you select through a single Prowler Cloud wizard.'
---
