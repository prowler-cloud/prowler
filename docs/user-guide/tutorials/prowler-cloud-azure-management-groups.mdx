...
Azure Resource Manager throttled Prowler's requests while it walked the hierarchy. Large tenants, and discoveries started back to back, are the common causes. Wait a few minutes, then click **Retry discovery**.
