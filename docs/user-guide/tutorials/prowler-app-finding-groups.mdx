---
title: 'Prowler Finding Groups'
description: 'Group security findings by check in Prowler App to cut noise, prioritize impact, mute at scale, and speed up cloud security triage across large environments.'
---
