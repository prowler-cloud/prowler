...
<Note>
Custom scan scheduling is available only in Prowler Cloud for accounts with a paid subscription. Prowler App and other open-source deployments support daily recurring scans every 24 hours, tied to the time when the provider was created. Trial or onboarding accounts can launch manual scans only.
</Note>
