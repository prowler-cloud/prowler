...
* **Prowler App:** Daily recurring scans every 24 hours, tied to the time when the provider was created.
</Note>
...
| Prowler App | Run manual scans and create daily recurring schedules every 24 hours during provider launch. The daily schedule is tied to the provider creation time, and custom cadence controls are unavailable. |
