...
The **Profile** tab shows the **Partner Information** card:

* **Company name** — the display name used in the console, in invitations and in outbound email.
* **Partner Code** — a read-only, Prowler-issued identifier. The helper text reads *"Share this code with customers to link their accounts."* Copy it with the button beside the field.

{/* IMAGE (pending): /images/prowler-for-msps/settings-profile.png — Settings Profile tab showing Partner Information and the copyable Partner Code field */}
