---
title: 'Prowler Cloud Email Alerts'
description: 'Create email alerts from Prowler Cloud findings to notify teams of critical security changes after each scan or through scheduled daily digests.'
---
