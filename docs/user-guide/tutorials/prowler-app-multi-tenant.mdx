---
title: 'Multi-Tenant Organizations in Prowler App'
description: 'Use Prowler App Organizations to isolate providers, scans, findings, and memberships across multiple teams or business units from a single user account.'
---
