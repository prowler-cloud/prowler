...
* **Membership:** The association between a user and an organization, including the assigned role (e.g., `owner`, or a custom role).
...
2. If already authenticated, the invitation is accepted automatically and the user is redirected to Prowler App.
    ...
    <img src="/images/prowler-app/multi-tenant/invitation-accept-loading.png" alt="Invitation being accepted automatically" width="700" />
...
3. If not authenticated, choose **I have an account -- Sign in**, authenticate with existing credentials, and the invitation is accepted upon sign-in.
    ...
    <img src="/images/prowler-app/multi-tenant/invitation-accept-choose.png" alt="Invitation smart routing - choose sign in or sign up" width="700" />
