---
title: 'Prowler GitHub Action'
description: 'Run Prowler cloud security scans in GitHub Actions with the official Docker-based action, push findings to Prowler Cloud, and upload SARIF to Code Scanning.'
---
