---
title: 'How Prowler Lighthouse AI Works'
description: 'Learn how Prowler Lighthouse AI combines LangChain agents, LLM providers, and the Prowler MCP server to answer questions about your cloud security findings.'
---
