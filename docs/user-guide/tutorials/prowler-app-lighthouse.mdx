...
Prowler Cignify AI integrates Large Language Models (LLMs) with Prowler security findings data.
...
<Note>
Cignify AI supports multiple LLM providers including OpenAI, Amazon Bedrock, and OpenAI-compatible services. For configuration details, see [Using Multiple LLM Providers with Lighthouse](/user-guide/tutorials/prowler-app-lighthouse-multi-llm).
</Note>
...
<img src="/images/prowler-app/lighthouse-architecture.png" alt="Cignify AI Architecture" />
...
Getting started with Prowler Cignify AI is easy:
...
<img src="/images/prowler-app/lighthouse-configuration.png" alt="Cignify AI Configuration" />

### Adding Business Context

The optional business context field lets you provide additional information to help Cignify AI understand your environment and priorities, including:
