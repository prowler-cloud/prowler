---
title: 'Import Findings into Prowler Cloud'
description: 'Upload OCSF Detection Finding scan results from Prowler CLI or other external sources into Prowler Cloud to centralize triage, alerts, and integrations.'
---
