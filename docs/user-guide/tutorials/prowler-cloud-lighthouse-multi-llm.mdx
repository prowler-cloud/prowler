---
title: 'Multiple LLM Providers for Lighthouse AI on Prowler Cloud'
description: 'Configure OpenAI, Amazon Bedrock, or OpenAI-compatible endpoints for Lighthouse AI on Prowler Cloud to match infrastructure, compliance, and cost needs.'
---
