...
Prowler Cloud runs an enhanced version of Lighthouse AI in Open Source repository, an Agentic Cloud Defender that helps teams understand, prioritize, and remediate security findings across cloud environments.
...
Lighthouse AI on Prowler Cloud introduces the following improvements over the open-source version:
