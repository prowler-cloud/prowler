---
title: 'Prowler App Amazon S3 Integration'
description: 'Automatically export Prowler App scan results in CSV, HTML, and OCSF JSON to an Amazon S3 bucket for archiving, analytics, and custom downstream workflows.'
---
