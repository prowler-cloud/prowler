...
<Note>
The **Add Customer** button is only shown to roles carrying **Manage workspaces**, which today means Superadmin.
</Note>
...
Choose **Edit** from the row actions to open the **Edit customer** panel. From there you can:

* **Rename** the customer. The new name must still be unique within your organization.
* **Move it to another workspace** using the workspace selector. This is how you re-scope which team members can see the customer. See [Organizing Customers into Workspaces](/user-guide/tutorials/prowler-for-msps-workspaces).
