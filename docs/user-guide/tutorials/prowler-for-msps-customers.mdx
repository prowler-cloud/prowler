...
description: "Add customers in Prowler for MSPs and MSSPs to provision a Prowler Cloud tenant, and open a customer's tenant from the console on their behalf."
---
