...
<Steps>
  ...
  <Step title="Set Their Billing Plan">
    ...
    {/* IMAGE (pending): /images/prowler-for-msps/add-customer-billing.png — Step 2 of the Add Customer wizard, showing the plan cards and the Monthly/Annual toggle */}
  </Step>
  ...
  <Step title="Launch Their Customer Workspace">
    ...
    {/* IMAGE (pending): /images/prowler-for-msps/add-customer-launch.png — Step 3 of the Add Customer wizard, showing the confirmation */}
  </Step>
</Steps>
