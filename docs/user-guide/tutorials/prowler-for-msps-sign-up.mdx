...
<Steps>
  <Step title="Open the sign-up page">
    Go to [partners.prowler.com/sign-up](https://partners.prowler.com/sign-up) and fill in **Full name**, **Company name**, **Email**, **Password** and **Confirm password**.

    {/* IMAGE (pending): /images/prowler-for-msps/sign-up-form.png — Sign-up form with all five fields */}
  </Step>
...
Sign in at [partners.prowler.com](https://partners.prowler.com) with your email and password. Select **Remember me** to keep the session alive longer between visits.

{/* IMAGE (pending): /images/prowler-for-msps/sign-in-form.png — Sign-in form showing the Remember me checkbox and the Forgot password link */}
