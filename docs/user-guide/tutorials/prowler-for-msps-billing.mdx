...
description: "Manage customer billing plans in Prowler for MSPs and MSSPs: choose monthly or annual, set the provider account count, and change a customer's plan."
---
