...
<Frame>
  <img src="/images/organizations/discovery-timeout.png" alt="Discovery timeout notice offering Keep waiting and Retry" />
</Frame>
...
{/* SCREENSHOT: "Replace existing credentials?" modal listing the affected accounts, with Cancel and "Replace and continue". */}
<Frame>
  <img src="/images/organizations/replace-credentials-apply.png" alt="Replace existing credentials modal listing the accounts whose credentials will be replaced" />
</Frame>
...
{/* SCREENSHOT: Row actions menu open on an AWS organization row, showing every available action. */}
<Frame>
  <img src="/images/organizations/organization-row-actions.png" alt="Row actions menu on an AWS organization row" />
</Frame>
...
<Frame>
  <img src="/images/organizations/replace-credentials-setup.png" alt="Replace existing credentials modal showing how many providers re-authenticate" />
</Frame>
...
{/* SCREENSHOT: Delete confirmation dialog for an AWS organization, showing the cascade provider count. */}
<Frame>
  <img src="/images/organizations/delete-organization.png" alt="Delete organization dialog showing how many providers are deleted with it" />
</Frame>
