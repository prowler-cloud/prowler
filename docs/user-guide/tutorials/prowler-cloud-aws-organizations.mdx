...
description: 'Use the Prowler Cloud wizard to discover every AWS Organization account, select which to monitor, test connectivity, and launch scans without any scripts.'
---
