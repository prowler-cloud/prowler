...
|--------------|------------------|
| Prowler Cloud paid subscription | Create a custom recurring schedule for all connected accounts: daily, every 48 hours, weekly, or monthly. |
| Prowler Cloud trial or onboarding | Run one-time manual scans only. |
| Prowler App or other open-source deployments | Create a daily recurring scan every 24 hours, tied to the provider creation time, or run a one-time manual scan. |
