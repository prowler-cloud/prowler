...
{/* SCREENSHOT: Google Cloud console, IAM & Admin > Settings, with the numeric Organization ID highlighted. */}
<Frame>
  <img src="/images/organizations/gcp/gcp-console-org-id.png" alt="Google Cloud console showing the numeric organization ID" />
</Frame>
...
{/* SCREENSHOT: Provider selection step of the wizard with the Google Cloud card highlighted. */}
<Frame>
...
{/* SCREENSHOT: Method selector showing "Add A Single GCP Project" and "Add Multiple Projects With GCP Organization", with the second option highlighted. */}
<Frame>
...
{/* SCREENSHOT: "Google Cloud (GCP) / Organization Details" step with Organization ID and Name fields filled. */}
<Frame>
...
{/* SCREENSHOT: "Google Cloud (GCP) / Authentication Details" step showing both credential method cards and the Service Account Key textarea. */}
<Frame>
...
{/* SCREENSHOT: The "Gathering GCP Projects..." spinner during discovery. */}
<Frame>
...
{/* SCREENSHOT: The "Discovery is taking longer than expected" warning with the Keep waiting and Retry buttons. */}
<Frame>
...
{/* SCREENSHOT: Selection tree with nested folders, projects, checkboxes, alias inputs, and the "X of Y projects selected" header. */}
<Frame>
...
{/* SCREENSHOT: A blocked project row grayed out with its reason tooltip open. */}
<Frame>
...
{/* SCREENSHOT: A disabled folder row with the "No projects available to select in this folder." note, expanded to reveal blocked projects. */}
<Frame>
...
{/* SCREENSHOT: "Replace existing credentials?" modal listing the affected projects, with Cancel and "Replace and continue". */}
<Frame>
...
{/* SCREENSHOT: Connection testing in progress, with spinners and success icons on individual project rows. */}
<Frame>
...
An error banner appears: **"There was a problem connecting to some projects."** You have two options:
...
If **no project** connects, you cannot proceed. Fix the underlying problem — see [Troubleshooting](#troubleshooting) — and retry.
...
{/* SCREENSHOT: Launch step showing "Projects Connected!", the schedule selector, and the launch action. */}
<Frame>
...
{/* SCREENSHOT: Providers page with the GCP organization row expanded, showing folder rows and project providers beneath them. */}
<Frame>
...
{/* SCREENSHOT: Row actions menu open on a GCP organization row, showing every available action. */}
<Frame>
...
{/* SCREENSHOT: "Replace existing credentials?" modal showing the affected provider count, with Cancel and "Replace credentials". */}
<Frame>
...
{/* SCREENSHOT: Delete confirmation dialog for a GCP organization, showing the cascade provider count. */}
<Frame>
