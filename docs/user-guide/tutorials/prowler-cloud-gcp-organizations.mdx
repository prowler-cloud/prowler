...
description: 'Discover every Google Cloud folder and project under your organization and onboard the ones you select through a single Prowler Cloud guided wizard.'
---
