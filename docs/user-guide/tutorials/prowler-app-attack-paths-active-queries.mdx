...
description: "Focus Attack Paths on queries with data: Prowler Cloud records query results per scan and hides confirmed-empty queries from the selector automatically."
---
