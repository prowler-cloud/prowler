---
title: 'Users and RBAC in Prowler App'
description: 'Invite users, assign roles, and configure Role-Based Access Control in Prowler App to govern permissions on providers, scans, findings, and integrations.'
---
