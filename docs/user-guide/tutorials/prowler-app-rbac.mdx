...
<Note>
Editing user account details requires the **Invite and Manage Users** or **admin** permission. Users without this permission cannot update their own account details from this user-management endpoint and should ask an administrator to make the change.
