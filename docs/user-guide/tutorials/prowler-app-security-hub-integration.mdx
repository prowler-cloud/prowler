...
Enable the Prowler partner integration in AWS Security Hub by following the [AWS Security Hub setup documentation](/user-guide/tutorials/aws/securityhub#enabling-aws-security-hub-for-prowler-integration).

### AWS Authentication

Configure AWS credentials by following the [AWS authentication setup guide](/user-guide/tutorials/aws/getting-started-aws#step-3-set-up-aws-authentication).
...
After successful configuration and scan completion, Prowler findings automatically appear in AWS Security Hub. For detailed information about accessing and interpreting findings in the Security Hub console, refer to the [AWS Security Hub findings documentation](/user-guide/tutorials/aws/securityhub#viewing-prowler-findings-in-aws-security-hub).
