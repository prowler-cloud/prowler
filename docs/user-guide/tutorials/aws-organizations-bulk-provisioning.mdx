...
description: 'Auto-discover every account in an AWS Organization and generate YAML config to bulk provision Prowler App and Prowler Cloud with a single CLI tool.'
---
