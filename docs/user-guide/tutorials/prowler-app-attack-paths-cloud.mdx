---
title: "Attack Paths"
description: "Attack Paths enhancements available only in Prowler Cloud and Prowler Private Cloud, including automatic filtering of queries that returned data."
---
...
Prowler Cloud and Prowler Private Cloud extend the base [Attack Paths](/user-guide/tutorials/prowler-app-attack-paths) feature with capabilities that rely on managed scan infrastructure. This page documents the enhancements available only in these products.
