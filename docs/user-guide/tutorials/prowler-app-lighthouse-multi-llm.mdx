---
title: 'Multiple LLM Providers in Lighthouse AI'
description: 'Configure OpenAI, Amazon Bedrock, or OpenAI-compatible endpoints as LLM providers for Prowler Lighthouse AI on self-hosted Prowler App deployments.'
---
