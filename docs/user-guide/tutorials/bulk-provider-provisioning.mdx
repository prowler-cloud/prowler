...
description: 'Onboard AWS, Azure, GCP, Kubernetes, M365, and GitHub providers into Prowler App or Prowler Cloud in bulk from YAML files using the provisioning CLI tool.'
---
