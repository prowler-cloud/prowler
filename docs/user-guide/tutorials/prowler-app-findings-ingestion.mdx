...
Findings Ingestion enables uploading scan results in OCSF (Open Cybersecurity Schema Framework) format to Prowler Cloud. This feature supports importing findings from the Prowler CLI using the [Detection Finding](https://schema.ocsf.io/classes/detection_finding) class.
