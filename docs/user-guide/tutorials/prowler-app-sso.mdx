...
2.  Enter the **primary email domain** for the organization (e.g., `mycompany.com`). Prowler Cloud uses this domain to identify users who should authenticate through SAML and to generate the Assertion Consumer Service (ACS) URL.
