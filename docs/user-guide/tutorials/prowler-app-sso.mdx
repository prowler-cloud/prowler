---
title: 'SAML SSO in Prowler App'
description: 'Configure SAML-based Single Sign-On in Prowler App with any Identity Provider, plus developer and administrator guidance for self-hosted deployments.'
---
