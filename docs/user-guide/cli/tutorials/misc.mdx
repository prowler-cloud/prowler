...
- Filter by categories in the Dashboard:

After running Prowler with specific categories, you can filter the results in the dashboard:
...
The dashboard includes a **Category** filter dropdown that allows you to view only findings from specific categories like `internet-exposed`, `encryption`, `logging`, etc.
