...
| `awslambda_function_using_supported_runtimes`                          | `obsolete_lambda_runtimes`                        | Integer         | See `config.yaml`                                                                                                                    |
| `awslambda_function_vpc_is_in_multi_azs`                               | `lambda_min_azs`                                  | Integer         | `2`                                                                                                                                  |
...
| Check Name                    | Value                      | Type   | Default                                                                                |
|-------------------------------|----------------------------|--------|----------------------------------------------------------------------------------------|
| `audit_log_maxbackup`         | `audit_log_maxbackup`      | String | `10`                                                                                   |
| `audit_log_maxsize`           | `audit_log_maxsize`        | String | `100`                                                                                  |
| `audit_log_maxage`            | `audit_log_maxage`         | String | `30`                                                                                   |
| `apiserver_strong_ciphers`    | `apiserver_strong_ciphers` | String | `["TLS_AES_128_GCM_SHA256", "TLS_AES_256_GCM_SHA384", "TLS_CHACHA20_POLY1305_SHA256"]` |
| `kubelet_strong_ciphers_only` | `kubelet_strong_ciphers`   | String | See `config.yaml`                                                                      |
