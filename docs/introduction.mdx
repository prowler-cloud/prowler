...
<Columns cols={2}>
  <Card title="Cignify CLI" icon="terminal" href="/getting-started/products/prowler-cli">
    Command Line Interface
  </Card>
  <Card title="Cignify App" icon="pen-to-square" href="/getting-started/products/prowler-app">
    Web Application
  </Card>
  <Card title="Cignify Cloud" icon="pen-to-square" href="/getting-started/products/prowler-cloud">
    A managed service built on top of Prowler App.
  </Card>
  <Card title="Cignify Hub" icon="map" href="/getting-started/products/prowler-hub">
