...
<Card title="Container Image Findings" icon="box" href="/security/container-images">
  Findings that remain in the published images, and why each cannot be resolved.
</Card>
